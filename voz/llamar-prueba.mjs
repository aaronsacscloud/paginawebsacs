...
const WS = process.env.VOZ_WS_URL || 'wss://code.sacscloud.com/voz/ws';
...
const body = new URLSearchParams({ To: A, From: DE, Url: url.toString(), Method: 'POST', Timeout: '30', MachineDetection: 'Enable', MachineDetectionTimeout: '15' });
...
console.log(`Marcando a ${A} · modo ${modo} · voz ${voz} · stt ${stt}\nitem ${item} · call ${j.sid} · estado ${j.status}`);
