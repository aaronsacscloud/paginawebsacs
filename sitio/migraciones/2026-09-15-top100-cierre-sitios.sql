-- Cierre del enriquecimiento del top 100: los sitios que dio Google Maps.
--
-- Tercera y ultima corrida. Google Maps le dio sitio web a cientos de cuentas
-- que antes solo tenian nombre; esto raspa esos 1,231 sitios.
--
-- Rendimiento: 226 correos, 156 WhatsApp declarados, 124 telefonos, 384
-- Instagram, 529 Facebook, 105 sitios caidos.
--
-- Mismas defensas de siempre: MX de cada dominio, el correo repetido entre
-- cuentas solo se conserva si es del mismo dominio que su sitio (cadena), y
-- ningun numero que aparezca en dos cuentas distintas.
...
('19d84be0-5414-45d5-84b3-754e0b51889a','email_generico','ventas@armariodelakaro.cl','media',true,'sin_probar'),
...
('9746d8c0-7644-4495-8ff5-8e3f9dfe4ca4','email_generico','intimourbanonoche@gmail.com','media',true,'sin_probar'),
('f333ad0e-b722-48c0-9d97-158f4dee0e64','whatsapp_tienda','526145990767','alta',true,'declarado'),
('2e835642-a427-4f1d-969e-41269323e73b','email_generico','contacto@twinsdresses.cl','media',true,'sin_probar'),
('711cff39-b78f-4699-a237-b9ca23e5e506','whatsapp_tienda','523335707402','alta',true,'declarado'),
('711cff39-b78f-4699-a237-b9ca23e5e506','telefono','523338193510','media',true,'sin_probar'),
...
('7339dfa3-1690-432d-8299-e48c3766b661','email_generico','casamatriz@thomasfiedler.cl','media',true,'sin_probar'),
...
('d37ff302-72f0-4565-93c0-80f21ab141c0','telefono','523816705773','media',true,'sin_probar'),
...
('9e700550-5b8a-4013-be24-2bbe03148c79','email_generico','hola@gloriatrevejos.com','media',true,'sin_probar'),
('0c53cf71-ece4-4c36-83d1-8eff977b294d','email_generico','moises@goodbyefolk.com','media',true,'sin_probar'),
('ad013ac5-f99a-4b78-b0b0-012f1509d755','telefono','523512373399','media',true,'sin_probar'),
...
('bca7e2f2-bac3-4105-93d3-60203b0b1b04','email_generico','casa_magaly@hotmail.com','media',true,'sin_probar'),
...
('ceb79c71-f05e-4ca2-88ef-0cf21a2c53bc','email_generico','info@catalinabayona.com','media',true,'sin_probar'),
...
('25bfec80-1872-4869-849d-5b2dea93d289','email_generico','info@click2dress.com','media',true,'sin_probar'),
...
('00d5da7f-6c98-46a4-8f87-420ed4a4a639','email_generico','contacto@nataliaarangonovias.com','media',true,'sin_probar'),
...
('fa3ac243-b75a-4b10-a54e-5ba26f0a0e04','email_generico','atencionalclientenissigenz@gmail.com','media',true,'sin_probar'),
...
('00b8b155-5276-49c1-811d-c5baeaaed872','telefono','523516001768','media',true,'sin_probar'),
('fb2fbf56-53a9-4d63-b711-ae6a6ef9597c','telefono','523412555727','media',true,'sin_probar'),
...
('f049f04f-a5a9-41aa-ad6b-69ce28577a2e','email_generico','info@esther.com.co','media',true,'sin_probar'),
...
('6998f232-2cbb-48d8-b822-255a3d93ee60','email_generico','ventas@mayabki.com.mx','media',true,'sin_probar'),
...
('4d0813c8-d264-4e9e-a18d-122272ecb2a6','whatsapp_tienda','525610012034','alta',true,'declarado'),
...
('f9fd990f-50eb-4ff0-a70f-0e312b1e9f47','telefono','525552809712','media',true,'sin_probar'),
...
('f9c6a3fc-04e5-40aa-83fa-da39d8e83c05','whatsapp_tienda','525551756997','alta',true,'declarado'),
...
('f97afd92-1762-473a-b0ee-b71536a77eb1','email_generico','ventas@borda2yestampa2.mx','media',true,'sin_probar'),
...
('09782e00-2f2a-45f9-b5fd-112b8b9cfa00','telefono','525530876515','media',true,'sin_probar'),
...
('60bc1994-8f56-46b3-a815-0403077df369','telefono','529982511054','media',true,'sin_probar'),
...
('99653f33-e7d2-41ed-9a36-eee167af07cb','email_generico','jreyes@onixmexico.com.mx','media',true,'sin_probar'),
('99653f33-e7d2-41ed-9a36-eee167af07cb','whatsapp_tienda','525571095027','alta',true,'declarado'),
('99653f33-e7d2-41ed-9a36-eee167af07cb','telefono','525571095027','media',true,'sin_probar'),
...
('531c2cf9-a4c5-40ed-a394-2bc577637763','email','atencion@elnuevomundo.com','sitio_propio','media','raspado-top3'),
('f7cbdfbe-c730-41dd-8d4b-b77aba2f3e9b','email','contacto@priceshoes.com','sitio_propio','media','raspado-top3'),
('f4716738-ccf2-4799-97d5-264e280db4cc','whatsapp','525518012835','sitio_propio','alta','raspado-top3'),
('68db6ac0-d319-4ca3-a1c9-2ebcb0c0ec06','email','info@sapica.com','sitio_propio','media','raspado-top3'),
('b9544a15-96aa-4d82-b4a2-e6dd7c34f1af','whatsapp','525546085201','sitio_propio','alta','raspado-top3'),
('9c6a66a5-1e25-4d6f-b002-14bd8a5c5866','whatsapp','523335881570','sitio_propio','alta','raspado-top3'),
('c90d67de-f822-4326-b00f-57843d3f942f','email','ayuda@chapur.com.mx','sitio_propio','media','raspado-top3'),
('db4f57c1-597f-4aab-8803-510dda717c66','email','info@granplazaoutlets.com','sitio_propio','media','raspado-top3'),
('6685002f-5fea-46b9-832b-64e8236ca5e7','whatsapp','525554795374','sitio_propio','alta','raspado-top3'),
('ef15b116-3d46-44b1-a5d0-d1e22a6d6ffa','email','moises@goodbyefolk.com','sitio_propio','media','raspado-top3'),
('7e1ff3f0-67c3-4d28-ba37-3535a3fe6771','whatsapp','522292153983','sitio_propio','alta','raspado-top3'),
('667ddee9-267a-4d92-89f5-c1c1fc72a1cd','email','infinitijoyas@gmail.com','sitio_propio','media','raspado-top3'),
('667ddee9-267a-4d92-89f5-c1c1fc72a1cd','whatsapp','528120326282','sitio_propio','alta','raspado-top3'),
('3a6db856-f6fa-49c4-8d0a-7368459af7d0','email','contacto@promoda.com.mx','sitio_propio','media','raspado-top3'),
('c69cff03-2bff-4068-b1ce-40b6a875bfc2','email','u003cdax@dax.com.mx','sitio_propio','media','raspado-top3'),
('de1036b0-98c2-4feb-905e-63db477957d4','email','contacto@miguelito.mx','sitio_propio','media','raspado-top3'),
('de1036b0-98c2-4feb-905e-63db477957d4','whatsapp','525610216294','sitio_propio','alta','raspado-top3'),
('e343b721-599f-48bd-afee-64cdacc0727e','whatsapp','528124277881','sitio_propio','alta','raspado-top3'),
('df468897-890d-4274-959d-132a68ad5251','email','info@yulygiraldo.com','sitio_propio','media','raspado-top3'),
('bbde869a-5a08-47e6-bd7d-9359ca2a9c1a','email','ventasonline@artistcity.com.mx','sitio_propio','media','raspado-top3'),
('19d84be0-5414-45d5-84b3-754e0b51889a','email','ventas@armariodelakaro.cl','sitio_propio','media','raspado-top3'),
('a08d6057-e06c-45c5-96e7-e26a23264b4b','email','ventas@garufajeans.com.mx','sitio_propio','media','raspado-top3'),
('a08d6057-e06c-45c5-96e7-e26a23264b4b','whatsapp','525530422356','sitio_propio','alta','raspado-top3'),
('25b97676-317c-4a7d-9490-43f6feae8db3','whatsapp','526462876359','sitio_propio','alta','raspado-top3'),
('86caece2-b9cb-4f4d-8b6b-dfc153e1aa4d','email','mindoracollection@gmail.com','sitio_propio','media','raspado-top3'),
('5ae9834f-c13c-4f0b-aeca-3919fa3bf127','email','contacto@moutyjoyeria.com','sitio_propio','media','raspado-top3'),
('9746d8c0-7644-4495-8ff5-8e3f9dfe4ca4','email','intimourbanonoche@gmail.com','sitio_propio','media','raspado-top3'),
('f333ad0e-b722-48c0-9d97-158f4dee0e64','whatsapp','526145990767','sitio_propio','alta','raspado-top3'),
('2e835642-a427-4f1d-969e-41269323e73b','email','contacto@twinsdresses.cl','sitio_propio','media','raspado-top3'),
('711cff39-b78f-4699-a237-b9ca23e5e506','whatsapp','523335707402','sitio_propio','alta','raspado-top3'),
('5334874c-f511-4447-aebe-20a2b380707b','email','ventas@ameliejoyas.com','sitio_propio','media','raspado-top3'),
('5334874c-f511-4447-aebe-20a2b380707b','whatsapp','523322214807','sitio_propio','alta','raspado-top3'),
('0e47ad7f-0183-4d55-904e-b4791c579b4b','whatsapp','523315841191','sitio_propio','alta','raspado-top3'),
('b497cffa-2f82-4a2c-8a0b-86c623f82f43','email','tasteenlinea@tasteboutique.com','sitio_propio','media','raspado-top3'),
('b497cffa-2f82-4a2c-8a0b-86c623f82f43','whatsapp','526622683344','sitio_propio','alta','raspado-top3'),
('8a80c96b-2a41-4cd6-87bf-0087bde98a16','email','info@hotelcasagonzalez.com','sitio_propio','media','raspado-top3'),
('3b432454-fc80-4b5d-9e24-ca5545e1115a','email','tennisexpress@icloud.com','sitio_propio','media','raspado-top3'),
('1e9dc983-caac-4ab5-8604-88659a4cc513','whatsapp','526641993698','sitio_propio','alta','raspado-top3'),
('a5b65ef8-220b-471e-bc82-7d86de89ef35','whatsapp','524773977372','sitio_propio','alta','raspado-top3'),
('3554b6ee-2fc1-4e46-b74d-69edc71cdcf6','email','contacto@elglobo.com.mx','sitio_propio','media','raspado-top3'),
('7339dfa3-1690-432d-8299-e48c3766b661','email','casamatriz@thomasfiedler.cl','sitio_propio','media','raspado-top3'),
('baabb0c4-7154-481a-89e9-3de73910fbd6','whatsapp','525586596023','sitio_propio','alta','raspado-top3'),
('42aba0d7-2c30-4f7e-8900-73501f971ea7','email','orlando.resendiz@zapateriafratello.com','sitio_propio','media','raspado-top3'),
('42aba0d7-2c30-4f7e-8900-73501f971ea7','whatsapp','524274270336','sitio_propio','alta','raspado-top3'),
('f32c7a6d-e3b7-40d0-941d-92f4be315fd1','email','hola@unser.com.mx','sitio_propio','media','raspado-top3'),
('f32c7a6d-e3b7-40d0-941d-92f4be315fd1','whatsapp','525549656879','sitio_propio','alta','raspado-top3'),
('748a6749-60c5-42e0-a413-b0dbf145f795','whatsapp','527712881783','sitio_propio','alta','raspado-top3'),
('2bac95e1-fcf2-4a46-b9a1-10c9b8dc60e8','email','contacto@binaboutique.com','sitio_propio','media','raspado-top3'),
('2bac95e1-fcf2-4a46-b9a1-10c9b8dc60e8','whatsapp','528118267337','sitio_propio','alta','raspado-top3'),
('3e7de61b-3fb6-405a-939e-1b7bb652a07f','whatsapp','525533407778','sitio_propio','alta','raspado-top3'),
('90171142-a2df-4d26-ac4a-e917d1b4ebae','email','hola@havoc.mx','sitio_propio','media','raspado-top3'),
('90171142-a2df-4d26-ac4a-e917d1b4ebae','whatsapp','525657822989','sitio_propio','alta','raspado-top3'),
('3ea426ee-26c4-4fc5-ba16-24d34285e878','email','ventaenlinea@cletoreyes.com','sitio_propio','media','raspado-top3'),
('5174c604-1ed0-4c92-8ed1-8d19bfeaa628','email','info@abbajoyas.com','sitio_propio','media','raspado-top3'),
('5174c604-1ed0-4c92-8ed1-8d19bfeaa628','whatsapp','523322291899','sitio_propio','alta','raspado-top3'),
('dc4e71dd-81c0-4645-8de8-99b4227edddd','email','contacto@zapatoagil.com','sitio_propio','media','raspado-top3'),
('42708317-5b28-4664-ad9f-4b3ba6f359f7','email','contacto@hhdxt.mx','sitio_propio','media','raspado-top3'),
('1d687be7-98a1-4c9e-b0c4-ecd77abb2f83','whatsapp','525522719809','sitio_propio','alta','raspado-top3'),
('c557337c-914e-468b-9ba0-90c6928461cb','email','amilcarfloresagency@gmail.com','sitio_propio','media','raspado-top3'),
('6fcb7904-a90b-49cf-9cf7-08a2eb034efd','email','hola@oggi.mx','sitio_propio','media','raspado-top3'),
('1b02c944-a17d-47b1-b1f1-05dabfcc12ed','email','ventas@bondsboutique.com.mx','sitio_propio','media','raspado-top3'),
('b97da424-d911-46c6-96f0-a53f8af26bd6','whatsapp','528136391003','sitio_propio','alta','raspado-top3'),
('62749c4c-3958-4248-963f-d7dc9a7e1b0b','whatsapp','523311105686','sitio_propio','alta','raspado-top3'),
('fd1aef1c-c768-4288-afcc-4319c370792c','email','info@carlo.mx','sitio_propio','media','raspado-top3'),
('fd1aef1c-c768-4288-afcc-4319c370792c','whatsapp','525567835967','sitio_propio','alta','raspado-top3'),
('5b503b2e-dc2c-4a0d-9869-b6bb93086224','whatsapp','525623871097','sitio_propio','alta','raspado-top3'),
('78638245-e3d3-4519-bfed-a5b2d3d0d15f','whatsapp','525517448241','sitio_propio','alta','raspado-top3'),
('ccf4daf9-7a2e-47ff-90bd-cfb39dfbe2f1','email','pedidos@elfamundi.com.mx','sitio_propio','media','raspado-top3'),
('ccf4daf9-7a2e-47ff-90bd-cfb39dfbe2f1','whatsapp','525615481365','sitio_propio','alta','raspado-top3'),
('76aa55e6-4374-4774-b38f-5cb32fc08b79','email','ecommerce@solatextil.mx','sitio_propio','media','raspado-top3'),
('c93c46ab-e8d6-4438-98c9-612881e9f218','email','ventas@uniformesescolaresalaman.com','sitio_propio','media','raspado-top3'),
('02ab88a5-f5fb-42aa-a610-4aceb85494ff','email','ventas@uniformeslaamistad.com','sitio_propio','media','raspado-top3'),
('a2a310cb-cd0f-44e2-a9bc-3cb4b7d06285','email','info@designplus.com.ar','sitio_propio','media','raspado-top3'),
('6c470b25-9163-48b3-aeba-46f995b9d8a8','email','ulamm@ulammjoyas.com','sitio_propio','media','raspado-top3'),
('6c470b25-9163-48b3-aeba-46f995b9d8a8','whatsapp','525559930600','sitio_propio','alta','raspado-top3'),
('a9ee1f64-615a-4169-ac1c-e7dafb49ff07','whatsapp','527225560013','sitio_propio','alta','raspado-top3'),
('5881b9a5-7719-49d3-a359-11089aac14b7','email','contacto@boutiquemonet.com','sitio_propio','media','raspado-top3'),
('5881b9a5-7719-49d3-a359-11089aac14b7','whatsapp','528117595771','sitio_propio','alta','raspado-top3'),
('bc9af7ef-e7f8-4ab7-8a50-31abb8c5ebf2','email','merceriadelrefugiomx@gmail.com','sitio_propio','media','raspado-top3'),
('9e700550-5b8a-4013-be24-2bbe03148c79','email','hola@gloriatrevejos.com','sitio_propio','media','raspado-top3'),
('0c53cf71-ece4-4c36-83d1-8eff977b294d','email','moises@goodbyefolk.com','sitio_propio','media','raspado-top3'),
('a4cb8a05-f96a-4295-b469-4ea82dd7b5d4','email','info@zittro.com','sitio_propio','media','raspado-top3'),
('a4cb8a05-f96a-4295-b469-4ea82dd7b5d4','whatsapp','524433249220','sitio_propio','alta','raspado-top3'),
('309b0946-763d-4434-bd08-5253d37fd7b6','whatsapp','526692657854','sitio_propio','alta','raspado-top3'),
('94690d47-7c4a-4d9f-8193-a040f65167a1','email','info@soybissu.com','sitio_propio','media','raspado-top3'),
('1c2c27bd-582b-490f-8d74-75ce72cf8d5a','email','chuz77z@gmail.com','sitio_propio','media','raspado-top3'),
('b9e82edf-57bd-423c-905b-fd1429a1934f','email','info@tuxedosvictors.com','sitio_propio','media','raspado-top3'),
('c4e824e1-f9b0-42e5-980c-6dbec6a316b8','email','lety@cimarron.com.mx','sitio_propio','media','raspado-top3'),
('8c736ae3-046c-4237-8f01-30c428d4046c','email','bellenoviah@gmail.com','sitio_propio','media','raspado-top3'),
('8136e2dc-0b10-4528-a8d8-350f1cfc82bc','email','hola@1000razones.com','sitio_propio','media','raspado-top3'),
('d844243b-66b2-4d64-849c-4080dafe9a18','whatsapp','526623002087','sitio_propio','alta','raspado-top3'),
('71a8858e-529a-42a8-aece-c15d7bece80b','whatsapp','524773833912','sitio_propio','alta','raspado-top3'),
('bca7e2f2-bac3-4105-93d3-60203b0b1b04','email','casa_magaly@hotmail.com','sitio_propio','media','raspado-top3'),
('d29c7b0e-824c-407f-bee0-4e82fc160147','email','mkt@analorena.com','sitio_propio','media','raspado-top3'),
('d29c7b0e-824c-407f-bee0-4e82fc160147','whatsapp','525574959937','sitio_propio','alta','raspado-top3'),
('ad0c66f7-09b7-4cd2-b337-1bd344b9d4d3','whatsapp','524611735444','sitio_propio','alta','raspado-top3'),
('e972edd5-0423-4ff9-bb9c-17bb2fce252b','whatsapp','525535772793','sitio_propio','alta','raspado-top3'),
('c48f7d65-3f94-4efd-8e51-952cfd4d1e1a','email','igor.cohen@gmail.com','sitio_propio','media','raspado-top3'),
('af41754d-27bf-4331-ba58-64cb45ba2d64','email','motooutlettoluca@hotmail.com','sitio_propio','media','raspado-top3'),
('af41754d-27bf-4331-ba58-64cb45ba2d64','whatsapp','527208639740','sitio_propio','alta','raspado-top3'),
('bd5d4bbf-86ff-4e3e-a6f2-30dc100562d0','whatsapp','526691101322','sitio_propio','alta','raspado-top3'),
('ceb79c71-f05e-4ca2-88ef-0cf21a2c53bc','email','info@catalinabayona.com','sitio_propio','media','raspado-top3'),
('fd445e1b-f887-4311-9ff4-bc37405504a3','email','atencionaclientes@veana.com','sitio_propio','media','raspado-top3'),
('166f34aa-c005-4cfc-ad84-ebf6f02a0994','email','ventas@uniformesescolaresalaman.com','sitio_propio','media','raspado-top3'),
('05fa5246-0ecf-46a3-a899-ae06e2606169','email','karlyta.galindo.bd@gmail.com','sitio_propio','media','raspado-top3'),
('05fa5246-0ecf-46a3-a899-ae06e2606169','whatsapp','524421143052','sitio_propio','alta','raspado-top3'),
('4b0aaba5-408a-4486-a101-fe6db52f6a5e','whatsapp','526621396339','sitio_propio','alta','raspado-top3'),
('f24a518a-deba-4287-9dc6-8755f0c5c616','email','sergio.soberanis@novedadestony.com','sitio_propio','media','raspado-top3'),
('f24a518a-deba-4287-9dc6-8755f0c5c616','whatsapp','529995720142','sitio_propio','alta','raspado-top3'),
('1ae3f863-3416-4bf0-b37a-a2c13d89d468','email','contacto@misvestidosgdl.com','sitio_propio','media','raspado-top3'),
('1ae3f863-3416-4bf0-b37a-a2c13d89d468','whatsapp','523321567135','sitio_propio','alta','raspado-top3'),
('25bfec80-1872-4869-849d-5b2dea93d289','email','info@click2dress.com','sitio_propio','media','raspado-top3'),
('a80005a7-67ad-4005-9abe-180c54d7f625','email','info@sposabridal.mx','sitio_propio','media','raspado-top3'),
('509b64b6-f33c-41c4-9d38-e1691d214a8f','email','citybride.info@gmail.com','sitio_propio','media','raspado-top3'),
('509b64b6-f33c-41c4-9d38-e1691d214a8f','whatsapp','523310310941','sitio_propio','alta','raspado-top3'),
('27552c30-0b3b-4e31-9301-400ae8ac33f0','whatsapp','523314212717','sitio_propio','alta','raspado-top3'),
('335f93d4-81d2-4c3b-8ac6-80c25327caa4','email','devoluciones@converse.com.mx','sitio_propio','media','raspado-top3'),
('7392dfa8-50a9-4d1b-8e67-f9982e0c7343','email','info@sposabella.mx','sitio_propio','media','raspado-top3'),
('7392dfa8-50a9-4d1b-8e67-f9982e0c7343','whatsapp','525555021116','sitio_propio','alta','raspado-top3'),
('812b651b-7b31-4599-8284-9a0b9ec48064','whatsapp','525571938391','sitio_propio','alta','raspado-top3'),
('b59c604a-0a3e-4cb6-b43a-f3776e9f69b1','whatsapp','525612622146','sitio_propio','alta','raspado-top3'),
('8063f4fc-7b11-451a-a7c7-ef20c9014e16','email','admin@carmenc.com','sitio_propio','media','raspado-top3'),
('8063f4fc-7b11-451a-a7c7-ef20c9014e16','whatsapp','524611859029','sitio_propio','alta','raspado-top3'),
('00d5da7f-6c98-46a4-8f87-420ed4a4a639','email','contacto@nataliaarangonovias.com','sitio_propio','media','raspado-top3'),
('0366747a-4ca2-4a49-9928-b4e1cfcc645e','email','info@libreriaacuario.com.mx','sitio_propio','media','raspado-top3'),
('0366747a-4ca2-4a49-9928-b4e1cfcc645e','whatsapp','522299510561','sitio_propio','alta','raspado-top3'),
('c6d17540-d5b9-4f35-a029-45ddb8f34c1c','email','online@pirma.com.mx','sitio_propio','media','raspado-top3'),
('fa3ac243-b75a-4b10-a54e-5ba26f0a0e04','email','atencionalclientenissigenz@gmail.com','sitio_propio','media','raspado-top3'),
('133558cd-6212-4893-b016-e57536f406f1','email','servicioaclientes@discalse.com','sitio_propio','media','raspado-top3'),
('ca8da1c2-861c-40b0-bf20-d895804967d3','email','centrodegraduaciones@gmail.com','sitio_propio','media','raspado-top3'),
('fdbd1104-dc98-4e87-9e4b-6995ca80b761','email','xtampalo@gmail.com','sitio_propio','media','raspado-top3'),
('bea3c06c-2d31-471b-ae4b-5291ed87da8e','email','l.luna@tejidosgaytan.com.mx','sitio_propio','media','raspado-top3'),
('77af4b9a-c838-40a3-ba45-e1b2d56e3397','email','hola@lineas.com.mx','sitio_propio','media','raspado-top3'),
('58e1f0cf-078b-4440-b4fd-9bef258d931c','whatsapp','522227095349','sitio_propio','alta','raspado-top3'),
('09d49604-ecd0-45d3-a242-e342446c1c21','email','admin@yotebordo.com','sitio_propio','media','raspado-top3'),
('3d1c7560-5bd0-4e4a-b303-06b4271faaab','whatsapp','525561894779','sitio_propio','alta','raspado-top3'),
('f049f04f-a5a9-41aa-ad6b-69ce28577a2e','email','info@esther.com.co','sitio_propio','media','raspado-top3'),
('dfddf52c-6ac3-4b9e-977d-6eaf252edd41','email','disfracesmexico@hotmail.com','sitio_propio','media','raspado-top3'),
('d1319988-d02a-43de-9eb5-1863673f2bd6','whatsapp','528122150093','sitio_propio','alta','raspado-top3'),
('6998f232-2cbb-48d8-b822-255a3d93ee60','email','ventas@mayabki.com.mx','sitio_propio','media','raspado-top3'),
('6998f232-2cbb-48d8-b822-255a3d93ee60','whatsapp','525531658139','sitio_propio','alta','raspado-top3'),
('58b048e5-cbe4-435e-b897-a2faf0e18a1d','email','elnopaltiendas@gmail.com','sitio_propio','media','raspado-top3'),
('58b048e5-cbe4-435e-b897-a2faf0e18a1d','whatsapp','526681934635','sitio_propio','alta','raspado-top3'),
('d4206644-a42f-4f0d-9a4c-c8a60df0700a','email','ventas@uniformesprovidencia.com.mx','sitio_propio','media','raspado-top3'),
('d4206644-a42f-4f0d-9a4c-c8a60df0700a','whatsapp','525564532052','sitio_propio','alta','raspado-top3'),
('4d0813c8-d264-4e9e-a18d-122272ecb2a6','email','andrea@lazzarmexico.com','sitio_propio','media','raspado-top3'),
('4d0813c8-d264-4e9e-a18d-122272ecb2a6','whatsapp','525610012034','sitio_propio','alta','raspado-top3'),
('d3522da1-28b4-47d9-af52-46e4feed1ebc','email','ventaenlinea@zapateriasrodriguez.com.mx','sitio_propio','media','raspado-top3'),
('8cbd2cf4-b15f-4093-8254-999ee5c245d5','email','pagos@sombrereriaregia.com.mx','sitio_propio','media','raspado-top3'),
('c82fa109-a067-4c78-9140-dc9ec0f6288b','whatsapp','523320808180','sitio_propio','alta','raspado-top3'),
('705a7235-ee7e-4a16-9864-dfdc19f160e8','email','ventas@juguel.com','sitio_propio','media','raspado-top3'),
('705a7235-ee7e-4a16-9864-dfdc19f160e8','whatsapp','528182749004','sitio_propio','alta','raspado-top3'),
('8ce0b732-6bcc-4f46-86b6-085c3edec111','email','jodie@silverexposure.com','sitio_propio','media','raspado-top3'),
('307a5c7d-b1dd-4a19-b523-3b7efd0088f0','email','pedidos@lanuevaespana.com.mx','sitio_propio','media','raspado-top3'),
('4b76ee5a-f684-4981-9270-ca7d8985fd31','whatsapp','526643108398','sitio_propio','alta','raspado-top3'),
('04f28815-81fa-4fdf-ba53-86e243bb6483','email','ecommerceoficial@berlei.com.mx','sitio_propio','media','raspado-top3'),
('dc65abc2-6d1e-4116-a4b2-d274cdb9ed4b','email','deportesjoyce@gmail.com','sitio_propio','media','raspado-top3'),
('dc65abc2-6d1e-4116-a4b2-d274cdb9ed4b','whatsapp','526671310033','sitio_propio','alta','raspado-top3'),
('e6fddaf6-829c-4a19-b40b-a4718057d309','email','soluciones@guayaberasycamisas.com','sitio_propio','media','raspado-top3'),
('337de5fd-27fb-49dc-9192-cb8dcb5053d1','email','help@help.desigual.com','sitio_propio','media','raspado-top3'),
('82430ccb-3620-48c4-8f96-183603db319a','email','info@ag925.mx','sitio_propio','media','raspado-top3'),
('f13bb6e2-c656-43bb-bdba-b399371bbf68','email','contacto@leonuniformes.com','sitio_propio','media','raspado-top3'),
('f13bb6e2-c656-43bb-bdba-b399371bbf68','whatsapp','525614930126','sitio_propio','alta','raspado-top3'),
('d7a8e361-8b1f-41f5-a46f-e9fc2d76e277','email','info@ciceg.org','sitio_propio','media','raspado-top3'),
('11b16e9a-c28f-48bb-94ba-fab2dd6721f4','email','email.establo@gmail.com','sitio_propio','media','raspado-top3'),
('add0e133-ece7-492b-8970-3db41083f58a','email','boss_mazaryk@hugoboss.com','sitio_propio','media','raspado-top3'),
('c03c432c-626a-4d7c-b968-1db28a7bdc96','whatsapp','522214144509','sitio_propio','alta','raspado-top3'),
('58583d1b-6d3d-4d58-9601-52fe0270764a','email','silvon@gruposilvon.com','sitio_propio','media','raspado-top3'),
('57909852-9593-41d5-ac54-527aa7c54123','whatsapp','526633182048','sitio_propio','alta','raspado-top3'),
('1b08c9fe-7941-4899-83c7-43cc7acc128b','email','ventas@textilesdelfuturo.com.mx','sitio_propio','media','raspado-top3'),
('b0ae85ab-7bfc-4250-afa8-f97f398a4844','email','web@uaem.mx','sitio_propio','media','raspado-top3'),
('b1817940-06cb-4fa2-bb57-38ae49a51942','email','info@bwigroup.com','sitio_propio','media','raspado-top3'),
('401d3296-2eb9-4171-9624-9463158e063e','email','ucmolegario@yahoo.com.mx','sitio_propio','media','raspado-top3'),
('210c6cac-927e-4f80-9958-3a62519380f8','email','garriaga@atleticos.com.mx','sitio_propio','media','raspado-top3'),
('c3384fc2-41f5-4935-91dd-8181de43ddb2','whatsapp','523319088880','sitio_propio','alta','raspado-top3'),
('1471b25e-5cea-4446-be1e-716789d6680b','email','info@origenespuebla.com','sitio_propio','media','raspado-top3'),
('1471b25e-5cea-4446-be1e-716789d6680b','whatsapp','522227649593','sitio_propio','alta','raspado-top3'),
('2776480b-d83b-4032-bd30-80fe57ae0028','email','nallely@corptextiljt.com.mx','sitio_propio','media','raspado-top3'),
('2fa4585b-37bb-4833-85e0-c3e6aef7c545','email','ventas@uniformesunico.com','sitio_propio','media','raspado-top3'),
('d7f0384c-86c3-4146-8df0-4f45b1ec345a','email','info@vigilante.com.mx','sitio_propio','media','raspado-top3'),
('e5abe833-595c-43cb-b851-838403715268','whatsapp','522216622781','sitio_propio','alta','raspado-top3'),
('a187cc47-976c-4361-8b90-cd7f410b90aa','whatsapp','526677770660','sitio_propio','alta','raspado-top3'),
('ec213370-85ca-4f12-8f53-80316682c759','email','uniformes.danmar@gmail.com','sitio_propio','media','raspado-top3'),
('5f231744-ec70-47d2-9fe7-85b3b7d05c43','email','admin@centrojoyerozocalo.com','sitio_propio','media','raspado-top3'),
('0b88264f-38db-4be3-939f-efff7c3480f3','email','info@lizakoekkoek.com','sitio_propio','media','raspado-top3'),
('0b88264f-38db-4be3-939f-efff7c3480f3','whatsapp','523322574268','sitio_propio','alta','raspado-top3'),
('01f4b2be-cfaf-49e5-814f-50e0b6ba7122','email','uniformes.donza@outlook.com','sitio_propio','media','raspado-top3'),
('fcf9d4e7-5c59-4eed-a283-77ed73925da7','whatsapp','528135578160','sitio_propio','alta','raspado-top3'),
('360941f8-7b03-4630-bf8b-e94256578277','email','info@gastrotourchef.com.mx','sitio_propio','media','raspado-top3'),
('360941f8-7b03-4630-bf8b-e94256578277','whatsapp','529842148080','sitio_propio','alta','raspado-top3'),
('a30eb6aa-7d90-4e15-8621-5cef9772244f','email','ventas@maxicaps.com.mx','sitio_propio','media','raspado-top3'),
('60b514ad-01f0-4b5e-985c-80cecc568df0','email','alaherradura1991@gmail.com','sitio_propio','media','raspado-top3'),
('053a5d84-8cf5-45ba-82ee-d369e457a0ae','email','joyeriayhechurasrivera@gmail.com','sitio_propio','media','raspado-top3'),
('b90c1134-fd3e-4cc7-a5d1-b6859b554ac8','email','silvon@gruposilvon.com','sitio_propio','media','raspado-top3'),
('6828bf67-fb34-437e-b313-0f4b2e84d523','email','zapatodiabetico@hotmail.com','sitio_propio','media','raspado-top3'),
('682ec899-95c2-499f-bf79-8f43eba6c3bf','email','informes@sombreroscuauhtemoc.mx','sitio_propio','media','raspado-top3'),
('682ec899-95c2-499f-bf79-8f43eba6c3bf','whatsapp','522224645368','sitio_propio','alta','raspado-top3'),
('0b8809b6-c63b-430f-9972-e87d8d741de7','email','ventas@t-lobordo.com','sitio_propio','media','raspado-top3'),
('528ea393-8fe0-4c89-84c3-54d2f4acd73e','email','ventas1@playerasmark.com','sitio_propio','media','raspado-top3'),
('2dec9dfe-4215-4970-a6d6-09487cb68141','email','mexico@lazzarmexico.com','sitio_propio','media','raspado-top3'),
('7e8e1136-5766-4dfb-9118-99ef44e1c33a','whatsapp','529993155009','sitio_propio','alta','raspado-top3'),
('00e7f440-0271-44ca-8225-39491feed712','email','tanyre71@gmail.com','sitio_propio','media','raspado-top3'),
('6558e2fb-2e22-432f-8b2c-aaf293c39cbc','email','contacto@chicaschein.com','sitio_propio','media','raspado-top3'),
('6163498b-dd73-40eb-9c91-ed7affe45f91','email','ventas@laperlajoyerias.com','sitio_propio','media','raspado-top3'),
('65d28f13-2b7f-4e6b-9391-f83bd26b627e','email','pedidosundoskin@hotmail.com','sitio_propio','media','raspado-top3'),
('65d28f13-2b7f-4e6b-9391-f83bd26b627e','whatsapp','523471041887','sitio_propio','alta','raspado-top3'),
('d0ac5186-324d-40f9-8dc5-eff4493e5009','email','ventas@marittijoyas.com','sitio_propio','media','raspado-top3'),
('d0ac5186-324d-40f9-8dc5-eff4493e5009','whatsapp','523329489466','sitio_propio','alta','raspado-top3'),
('14446fe4-fff0-472c-8c60-531f4ba39ed2','whatsapp','525515132253','sitio_propio','alta','raspado-top3'),
('e4e343d4-9312-482a-8c23-b8f347d9b2ce','whatsapp','523315573151','sitio_propio','alta','raspado-top3'),
('d2e8eb4e-b1c8-4db5-be99-28136977afe4','email','contacto@tecnosocks.com','sitio_propio','media','raspado-top3'),
('ddd8dee5-80a8-4882-b7f5-a7f032f9e42e','email','monterreystore@ferragamo.com','sitio_propio','media','raspado-top3'),
('8fcb5127-b9ec-4d82-a486-0d6331f87a5b','email','contacto@montblan.mx','sitio_propio','media','raspado-top3'),
('8fcb5127-b9ec-4d82-a486-0d6331f87a5b','whatsapp','522229003070','sitio_propio','alta','raspado-top3'),
('870fe4ef-10e8-491e-8219-68de23f676d7','whatsapp','525611720577','sitio_propio','alta','raspado-top3'),
('f9fd990f-50eb-4ff0-a70f-0e312b1e9f47','whatsapp','525552809712','sitio_propio','alta','raspado-top3'),
('35784eb2-1838-476f-ab89-1ea4a3f6029c','whatsapp','528186828115','sitio_propio','alta','raspado-top3'),
('11219b5e-fad7-4616-aec7-5409669632ad','whatsapp','524439345516','sitio_propio','alta','raspado-top3'),
('3d026714-ebe2-4b8e-82af-34c7a5a2ae63','email','tienda@pirouette.mx','sitio_propio','media','raspado-top3'),
('934bd69d-612b-41a1-aab4-2d728daf6aae','email','proviamiga@mundoprovidencia.com','sitio_propio','media','raspado-top3'),
('a503573c-b7bc-4ce6-94b0-b6d5addc82b0','email','hola@lineas.com.mx','sitio_propio','media','raspado-top3'),
('19578094-bd3d-46d1-b51b-8aa6b152816d','email','info@jdk.mx','sitio_propio','media','raspado-top3'),
('499ab6fa-7451-4ec4-b499-7852934f53a8','email','ventas@deportescancun.mx','sitio_propio','media','raspado-top3'),
('499ab6fa-7451-4ec4-b499-7852934f53a8','whatsapp','529984199828','sitio_propio','alta','raspado-top3'),
('1773fb70-d81e-4ee0-af76-ae6aa60fcbd0','email','recepcion@lozmerjoyeros.com','sitio_propio','media','raspado-top3'),
('e17a1506-35a2-4561-b1f1-955138d9a6b5','email','ventas@depielyalgomas.com','sitio_propio','media','raspado-top3'),
('e80b0246-d184-413e-94cd-37d6221f9347','email','ventas@emporiosport.com.mx','sitio_propio','media','raspado-top3'),
('e80b0246-d184-413e-94cd-37d6221f9347','whatsapp','525611073916','sitio_propio','alta','raspado-top3'),
('d93a629c-6b6d-407c-b2c8-22a5de084cf1','email','contacto@tiendasmaxima.com.mx','sitio_propio','media','raspado-top3'),
('8c2b4f19-2ff0-49b2-9075-6cc8ed3685d8','email','miradisfraces@gmail.com','sitio_propio','media','raspado-top3'),
('8c2b4f19-2ff0-49b2-9075-6cc8ed3685d8','whatsapp','529612264911','sitio_propio','alta','raspado-top3'),
('a3d7e60c-3383-490a-950a-b44d8eb08843','email','siniestrarockstore@gmail.com','sitio_propio','media','raspado-top3'),
('f9c6a3fc-04e5-40aa-83fa-da39d8e83c05','email','cponce@lazzarmexico.com','sitio_propio','media','raspado-top3'),
('f9c6a3fc-04e5-40aa-83fa-da39d8e83c05','whatsapp','525551756997','sitio_propio','alta','raspado-top3'),
('f3686905-1e68-45f4-a60a-74e42447cfd7','email','tintaseinsumos@hotmail.com','sitio_propio','media','raspado-top3'),
('f3686905-1e68-45f4-a60a-74e42447cfd7','whatsapp','529612140876','sitio_propio','alta','raspado-top3'),
('0fa91fdb-a089-4bb2-b958-1f6f9dfbc28d','whatsapp','525530580569','sitio_propio','alta','raspado-top3'),
('2690efaa-df63-4fd4-99d8-b58452806799','email','ventas@uniformeslaabejita.com','sitio_propio','media','raspado-top3'),
('2690efaa-df63-4fd4-99d8-b58452806799','whatsapp','523324968556','sitio_propio','alta','raspado-top3'),
('3339ae65-a4b2-4a48-b7a8-0ec608d47148','email','casa.tovar@hotmail.com','sitio_propio','media','raspado-top3'),
('3339ae65-a4b2-4a48-b7a8-0ec608d47148','whatsapp','524811232981','sitio_propio','alta','raspado-top3'),
('f7600e1d-6ab3-404e-a103-c68d41577d61','email','ventas1@codigouniformes.com.mx','sitio_propio','media','raspado-top3'),
('b617cf7e-70ed-44f3-8755-2e4b76b895aa','whatsapp','523221356302','sitio_propio','alta','raspado-top3'),
('6133b453-9a37-4aba-8af0-8da2c99631b2','email','andres.valens@uniformesfinoshidalgo.com','sitio_propio','media','raspado-top3'),
('6133b453-9a37-4aba-8af0-8da2c99631b2','whatsapp','528184598077','sitio_propio','alta','raspado-top3'),
('088dd8e8-7a4d-4665-bd59-b3f771f595f1','email','mondepell@gmail.com','sitio_propio','media','raspado-top3'),
('04ee700c-fdd7-4635-8df9-c79d0f905a18','whatsapp','528113807142','sitio_propio','alta','raspado-top3'),
('3e62a6a1-7fd1-4909-abf7-179b5d4c33ef','whatsapp','528120065308','sitio_propio','alta','raspado-top3'),
('d77932de-6c69-4230-8ced-1b1bfa148400','email','mercerias.net@gmail.com','sitio_propio','media','raspado-top3'),
('3f003ad8-8043-4d2a-bb06-428dd1ad090d','email','contacto@trajesdecharrogarcia.com.mx','sitio_propio','media','raspado-top3'),
('3f003ad8-8043-4d2a-bb06-428dd1ad090d','whatsapp','525515269182','sitio_propio','alta','raspado-top3'),
('6d2d3379-4fe2-40f9-bec2-533cae23fdf8','email','online@fiftyoutlet.com','sitio_propio','media','raspado-top3'),
('0ed6dadf-0d06-4f57-9d11-9b1368280431','email','contacto@latallaperfecta.com.mx','sitio_propio','media','raspado-top3'),
('3510f556-5a32-42e4-aaf6-54dea4cda932','email','contacto@playerasvallarta.com','sitio_propio','media','raspado-top3'),
('3510f556-5a32-42e4-aaf6-54dea4cda932','whatsapp','523221505264','sitio_propio','alta','raspado-top3'),
('8dcd8b2a-2492-4362-95a1-e167c0ca0532','email','vinitex2@hotmail.com','sitio_propio','media','raspado-top3'),
('8dcd8b2a-2492-4362-95a1-e167c0ca0532','whatsapp','523329189920','sitio_propio','alta','raspado-top3'),
('c386b80c-f5cf-468e-a9a5-bf43b018bcb1','email','cayala@uniformeskared.com','sitio_propio','media','raspado-top3'),
('c386b80c-f5cf-468e-a9a5-bf43b018bcb1','whatsapp','526188393020','sitio_propio','alta','raspado-top3'),
('771b0aa3-6b57-4648-8877-863f5578a21a','email','contacto@canaiveyucatan.org.mx','sitio_propio','media','raspado-top3'),
('771b0aa3-6b57-4648-8877-863f5578a21a','whatsapp','529995894487','sitio_propio','alta','raspado-top3'),
('8645c2a5-8e53-4279-a56d-be67490089ea','email','infokokodogz@gmail.com','sitio_propio','media','raspado-top3'),
('11c5918a-4588-4604-a6ec-2db04d0d38be','email','playerasgocas@gmail.com','sitio_propio','media','raspado-top3'),
('11c5918a-4588-4604-a6ec-2db04d0d38be','whatsapp','525623967852','sitio_propio','alta','raspado-top3'),
('f97afd92-1762-473a-b0ee-b71536a77eb1','email','ventas@borda2yestampa2.mx','sitio_propio','media','raspado-top3'),
('212a8734-1416-4c96-881e-25d143998f97','whatsapp','524494811213','sitio_propio','alta','raspado-top3'),
('7a6269bc-3bbc-4a2d-99d4-a025f28580f1','email','contacto@domikuniformes.com','sitio_propio','media','raspado-top3'),
('c8677487-5aa1-431a-bedf-31d8809d1bac','email','contacto@domikuniformes.com','sitio_propio','media','raspado-top3'),
('09782e00-2f2a-45f9-b5fd-112b8b9cfa00','whatsapp','525564805977','sitio_propio','alta','raspado-top3'),
('65d7ff4b-257b-4d23-a08b-8833d91668b8','email','tecnoserviciosgto@gmail.com','sitio_propio','media','raspado-top3'),
('65d7ff4b-257b-4d23-a08b-8833d91668b8','whatsapp','524779219895','sitio_propio','alta','raspado-top3'),
('a3d0e3a5-d9a6-486a-8465-90fb9de68484','email','ventas1@codigouniformes.com.mx','sitio_propio','media','raspado-top3'),
('9385cdff-2f38-42d6-b53c-3806c140333b','email','ventas@unipromo.mx','sitio_propio','media','raspado-top3'),
('9385cdff-2f38-42d6-b53c-3806c140333b','whatsapp','526861152777','sitio_propio','alta','raspado-top3'),
('8b5c08c7-c664-4150-bd0a-16db011e8b85','email','compras@romen.com.mx','sitio_propio','media','raspado-top3'),
('8b5c08c7-c664-4150-bd0a-16db011e8b85','whatsapp','525543243680','sitio_propio','alta','raspado-top3'),
('978ee5e3-6fa5-478d-a01b-dd5e3aa96466','whatsapp','528261592014','sitio_propio','alta','raspado-top3'),
('1c85a9ab-f14f-4084-ab90-3fd8d095bbaa','whatsapp','523316972569','sitio_propio','alta','raspado-top3'),
('05b32f49-5067-4eda-9a0c-423f952a1786','email','contacto@croga.com.mx','sitio_propio','media','raspado-top3'),
('ce4224ff-b3ea-4636-8aee-c52502a1e4a9','email','info@estopasfinasags.com.mx','sitio_propio','media','raspado-top3'),
('67560147-f568-43ff-8476-5b5f3d538cb0','email','info@uniformesybordados.mx','sitio_propio','media','raspado-top3'),
('c5322663-da1e-455b-b4ef-7fed9c42b1c2','email','ventas1@playerasmark.com','sitio_propio','media','raspado-top3'),
('980b321d-bee9-4e9e-a894-2f947eb71202','email','info@belisapulido.com','sitio_propio','media','raspado-top3'),
('0802e5d1-32c3-4a03-bf6d-c031f138c1bd','email','tonnny_05@hotmail.com','sitio_propio','media','raspado-top3'),
('129efa40-f59b-46d7-a408-12f66a8b04ad','whatsapp','525578343522','sitio_propio','alta','raspado-top3'),
('b4d2ba6f-4e61-43bf-9ae8-5c1bc7954f62','whatsapp','523321670061','sitio_propio','alta','raspado-top3'),
('ee4d1c3c-9d95-46bd-b741-97b0136bbedb','whatsapp','523310115736','sitio_propio','alta','raspado-top3'),
('3048c1d3-de37-4491-8134-e9515317fffc','email','contacto@cuelloblanco.com.mx','sitio_propio','media','raspado-top3'),
('3048c1d3-de37-4491-8134-e9515317fffc','whatsapp','524428899350','sitio_propio','alta','raspado-top3'),
('3f74952f-3e92-4192-8b87-e44a7221c62f','email','admon@troppomoda.com','sitio_propio','media','raspado-top3'),
('4a8690d9-9f66-4061-b470-2022b29720cd','email','info@mayro.com.mx','sitio_propio','media','raspado-top3'),
('e1c1aba0-a28f-4cf0-91b9-e782870aac54','email','ventas@carmenrion.com','sitio_propio','media','raspado-top3'),
('e1c1aba0-a28f-4cf0-91b9-e782870aac54','whatsapp','525574381890','sitio_propio','alta','raspado-top3'),
('db959d23-de72-4107-8258-92ff43a8c097','email','ventas@cqualy.com','sitio_propio','media','raspado-top3'),
('2a5feb11-978b-4667-adf3-ebcbfeac3fd8','email','negocios@regency.com.mx','sitio_propio','media','raspado-top3'),
('9ae3759d-634d-48c3-835e-fbc9082cf3a9','email','sac@piccini.com.mx','sitio_propio','media','raspado-top3'),
('9ae3759d-634d-48c3-835e-fbc9082cf3a9','whatsapp','528441223946','sitio_propio','alta','raspado-top3'),
('4430543b-78c0-480e-94a5-25eef53299e2','email','sublim@sublimpromocionales.com','sitio_propio','media','raspado-top3'),
('4430543b-78c0-480e-94a5-25eef53299e2','whatsapp','522228476388','sitio_propio','alta','raspado-top3'),
('015f8a5f-937e-4043-a294-376d11f0fe46','whatsapp','525594149691','sitio_propio','alta','raspado-top3'),
('b6f2075c-a357-48b3-90af-293f39d70493','email','yumuri@yumuri.com.mx','sitio_propio','media','raspado-top3'),
('aabc44a2-12de-4317-a151-dba49ef8bc70','whatsapp','528110147973','sitio_propio','alta','raspado-top3'),
('dbcceb96-dea8-461f-b65c-e7ba89ceb603','email','sales@elcharro1.com','sitio_propio','media','raspado-top3'),
('51351386-4d11-45a3-a398-537c621d3530','whatsapp','524773298055','sitio_propio','alta','raspado-top3'),
('5500c478-5804-4f13-81fa-4cd088f3a5ff','email','informacion@secretodepandora.com','sitio_propio','media','raspado-top3'),
('5500c478-5804-4f13-81fa-4cd088f3a5ff','whatsapp','524434753747','sitio_propio','alta','raspado-top3'),
('a92f9cb7-dd3c-4df5-aef2-94a6dd5b5afd','email','lau.cecilia93@gmail.com','sitio_propio','media','raspado-top3'),
('e75d1221-7ce4-4e13-9f34-2d066d5af770','email','pantaloneseljefe@gmail.com','sitio_propio','media','raspado-top3'),
('e75d1221-7ce4-4e13-9f34-2d066d5af770','whatsapp','528134023112','sitio_propio','alta','raspado-top3'),
('9b412fe9-0a2c-40d6-b89a-25a667b71fe2','email','textildistribuidores@hotmail.com','sitio_propio','media','raspado-top3'),
('9b412fe9-0a2c-40d6-b89a-25a667b71fe2','whatsapp','526671023025','sitio_propio','alta','raspado-top3'),
('c2c13bef-0286-44b8-97fa-1deb0c7f2718','whatsapp','528443146666','sitio_propio','alta','raspado-top3'),
('7bed4365-cb81-48c0-b2a9-3db18c086fe8','whatsapp','522226820694','sitio_propio','alta','raspado-top3'),
('d60ebcaa-442d-4a0b-97a6-d053ea9a573e','email','su.moda.real@gmail.com','sitio_propio','media','raspado-top3'),
('1f9fef63-6da4-42f6-8871-d125c5f3babf','email','ventas@latijera.mx','sitio_propio','media','raspado-top3'),
('365bd8d2-415e-478c-b6dc-af8323aa7557','email','joyasarco@gmail.com','sitio_propio','media','raspado-top3'),
('365bd8d2-415e-478c-b6dc-af8323aa7557','whatsapp','523318726197','sitio_propio','alta','raspado-top3'),
('471061fa-dee3-4256-9095-2dfef171ec9b','email','hola@benandfrank.com','sitio_propio','media','raspado-top3'),
('471061fa-dee3-4256-9095-2dfef171ec9b','whatsapp','525571000395','sitio_propio','alta','raspado-top3'),
('b7ea6113-a228-4275-b17d-364a2727354f','email','ventas1@sparviero.com.mx','sitio_propio','media','raspado-top3'),
('e67fcf69-6fa7-4630-927b-98c2191c14a4','whatsapp','525565085710','sitio_propio','alta','raspado-top3'),
('86727926-ef0e-49f9-b94a-3fd2e0a58871','email','contacto@stractto.com','sitio_propio','media','raspado-top3'),
('86727926-ef0e-49f9-b94a-3fd2e0a58871','whatsapp','523311867900','sitio_propio','alta','raspado-top3'),
('aff49070-9fb1-4603-a8e5-9789ba1f35f5','whatsapp','524421139948','sitio_propio','alta','raspado-top3'),
('e2ada293-4e65-427b-8127-46b1417a2352','email','calicuse@yahoo.com.mx','sitio_propio','media','raspado-top3'),
('eac11301-cd8b-4f91-8e5e-08406d1637d0','email','info@outletdeplayeras.com','sitio_propio','media','raspado-top3'),
('d80d99d1-945d-4f84-88e6-effe5dec9cf5','email','info@canaive.mx','sitio_propio','media','raspado-top3'),
('d80d99d1-945d-4f84-88e6-effe5dec9cf5','whatsapp','525555887822','sitio_propio','alta','raspado-top3'),
('15221201-a3d1-43ce-80cd-09fb88408cf6','whatsapp','523330287951','sitio_propio','alta','raspado-top3'),
('9862b719-b249-4ba0-8d54-b1afc60b42bc','email','joel.cruz@lamaria.com.mx','sitio_propio','media','raspado-top3'),
('d5607099-0c9c-4bad-bf0b-c30aa3f6cc5e','email','info@estampalo.com','sitio_propio','media','raspado-top3'),
('30de2680-7010-4cf2-820e-ae2a9a541630','email','ventas@logosybordados.com','sitio_propio','media','raspado-top3'),
('cf4b7967-7b13-4a86-ba74-7871a7fec39d','email','redibytes@gmail.com','sitio_propio','media','raspado-top3'),
('dfbe5c09-f82c-492d-88ce-a5dd065e8e87','whatsapp','529512402734','sitio_propio','alta','raspado-top3'),
('4ee96139-3bfa-45f7-b339-ce896d456903','email','contacto@actiongroup.com.mx','sitio_propio','media','raspado-top3'),
('96735d8a-0393-4d8c-9caf-97ce9e9c5189','email','info@outletdeplayeras.com','sitio_propio','media','raspado-top3'),
('60bc1994-8f56-46b3-a815-0403077df369','whatsapp','529984293045','sitio_propio','alta','raspado-top3'),
('8669ffd3-ac15-40fc-80a2-ca8ec3b61c63','email','ventas@maxicaps.com.mx','sitio_propio','media','raspado-top3'),
('614e905c-7e9c-4401-a2db-2c476d125442','email','rvillasante@viye.com.mx','sitio_propio','media','raspado-top3'),
('614e905c-7e9c-4401-a2db-2c476d125442','whatsapp','525641151488','sitio_propio','alta','raspado-top3'),
('431e2b5e-fbba-41e9-bce9-4f78eb10c6ed','email','contacto@promoscreativos.com','sitio_propio','media','raspado-top3'),
('5e82f579-ee98-468b-8359-490fab7ee05e','whatsapp','528112088178','sitio_propio','alta','raspado-top3'),
('8fcea235-9933-4ec9-a57e-e5b727896bea','email','jorge.castelan@casbec.com.mx','sitio_propio','media','raspado-top3'),
('6adbdd4a-9ac7-41a1-abeb-497a7adbef6e','whatsapp','525572482687','sitio_propio','alta','raspado-top3'),
('5a733d0f-b23c-4eed-8199-27c8e9a59bfd','email','contacto@desportik.com','sitio_propio','media','raspado-top3'),
('eabec169-50c3-49ab-85b0-5beaf1737f94','whatsapp','528116291526','sitio_propio','alta','raspado-top3'),
('84d864c5-cb1b-4e97-a26a-4471f6faa3cf','email','contacto@sportico.com.mx','sitio_propio','media','raspado-top3'),
('84d864c5-cb1b-4e97-a26a-4471f6faa3cf','whatsapp','525561663960','sitio_propio','alta','raspado-top3'),
('911ceb05-3c99-4f0a-abd7-5f77f666e695','email','support@calcetinespachuca.store','sitio_propio','media','raspado-top3'),
('68d10e68-ef1b-48e6-8001-7ccc603cda00','email','atencion@scappino.com','sitio_propio','media','raspado-top3'),
('68d10e68-ef1b-48e6-8001-7ccc603cda00','whatsapp','525543481019','sitio_propio','alta','raspado-top3'),
('9ec175bf-b008-4d2a-b0e3-ab665a25c86a','email','hugo_puntovalle@hugoboss.com','sitio_propio','media','raspado-top3'),
('1905828a-8f2d-438c-9014-a7a58020dde3','email','atenciononline@duo.com.mx','sitio_propio','media','raspado-top3'),
('1905828a-8f2d-438c-9014-a7a58020dde3','whatsapp','526682360911','sitio_propio','alta','raspado-top3'),
('4bdd28ba-468e-42c5-9111-6b0d8f932343','whatsapp','528114642039','sitio_propio','alta','raspado-top3'),
('eb17044f-8008-41f1-898a-7d9cc0ab29ab','email','contacto@streetsilver.mx','sitio_propio','media','raspado-top3'),
('594315b5-8f96-42e9-9ad0-5de84aa65364','email','juan.vera@comprausadomexico.com.mx','sitio_propio','media','raspado-top3'),
('594315b5-8f96-42e9-9ad0-5de84aa65364','whatsapp','525585803322','sitio_propio','alta','raspado-top3'),
('e1bf4122-4f17-4aa3-80dd-5cd2e5b62889','email','contacto@vintagedecoracion.com.mx','sitio_propio','media','raspado-top3'),
('e1bf4122-4f17-4aa3-80dd-5cd2e5b62889','whatsapp','526141704233','sitio_propio','alta','raspado-top3'),
('868bd200-0e45-460c-a2fe-95c6b3662b3e','email','georgerdz24@gmail.com','sitio_propio','media','raspado-top3'),
('99653f33-e7d2-41ed-9a36-eee167af07cb','email','jreyes@onixmexico.com.mx','sitio_propio','media','raspado-top3'),
('99653f33-e7d2-41ed-9a36-eee167af07cb','whatsapp','525571095027','sitio_propio','alta','raspado-top3'),
('81dbf9e7-9e83-4def-b38d-9df9cb76255e','whatsapp','528127534215','sitio_propio','alta','raspado-top3'),
('4b69fd17-f18b-4f8a-9d51-ff9a2b0160e7','email','ventas@blackkissmx.com','sitio_propio','media','raspado-top3'),
('0d11aafb-1949-4cc2-8dac-0dee13e62f89','email','info@candyshop.com.mx','sitio_propio','media','raspado-top3'),
('2103cbb1-f503-4b44-a0f2-1e3470457214','whatsapp','525554682563','sitio_propio','alta','raspado-top3'),
('69ad1de6-de84-407c-a115-b910058c83b8','email','ventas@fabricadetrajesdecharrogabrieles.com','sitio_propio','media','raspado-top3'),
('69ad1de6-de84-407c-a115-b910058c83b8','whatsapp','525537015964','sitio_propio','alta','raspado-top3'),
('527bd42d-7414-4797-a7b3-4f4b3ac5fb02','email','contacto@sary.com.mx','sitio_propio','media','raspado-top3'),
('bde30ac4-6ae8-4598-b285-599bde364ff2','whatsapp','524771794796','sitio_propio','alta','raspado-top3'),
('ce81327a-4ae5-42da-8cdc-0d8e75249ffd','whatsapp','523318474081','sitio_propio','alta','raspado-top3'),
('cbd1f859-9cda-48c4-bfce-b6aecdfcbbe5','email','canaivetehuacan@gmail.com','sitio_propio','media','raspado-top3'),
('e5a1a820-819d-49b4-b97a-1414d463abf2','email','bikinisriosyvalles@gmail.com','sitio_propio','media','raspado-top3'),
('e5a1a820-819d-49b4-b97a-1414d463abf2','whatsapp','523112378341','sitio_propio','alta','raspado-top3'),
('be60033f-3dad-4bd9-822b-bcbba9582c95','whatsapp','528128908120','sitio_propio','alta','raspado-top3'),
('03854931-06e1-4857-bb26-37aef1e9c635','email','alcala831@hotmail.com','sitio_propio','media','raspado-top3'),
('760cc90f-c55d-48cf-848d-dd5ad037f411','email','info@visualmerchandisinglab.com','sitio_propio','media','raspado-top3'),
('08acbcc4-c9f4-4285-b5d6-96e36db86567','email','pliegohats@yahoo.com','sitio_propio','media','raspado-top3'),
('cd4cd6c0-54e9-4943-9db0-b484364d149c','email','ventas@mrcachuchero.com','sitio_propio','media','raspado-top3'),
('cd4cd6c0-54e9-4943-9db0-b484364d149c','whatsapp','528661021666','sitio_propio','alta','raspado-top3'),
('44f43319-b65d-40b8-96c0-50e3f4eb9662','whatsapp','525648967642','sitio_propio','alta','raspado-top3');
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='a02badd7-1506-4285-a154-52bbbe64361f';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/armariodelakaro_temuco'), facebook=coalesce(facebook,'https://facebook.com/armariodelakaro') where id='19d84be0-5414-45d5-84b3-754e0b51889a';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/hadaclothes'), facebook=coalesce(facebook,'https://facebook.com/2008') where id='c572d518-1d4a-40eb-8a15-6fc627eb2caa';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/dressmeupargentina'), facebook=coalesce(facebook,'https://facebook.com/dressmeupargentina') where id='38d9cf28-7b14-461d-8782-6a7f893b669e';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/lalapitadress'), facebook=coalesce(facebook,'https://facebook.com/lalapitadress') where id='36e3e5c1-52ad-4103-bb8e-f1748038f315';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='685d1f44-8dec-4fcf-8e91-45487021c49d';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/intimourbano'), facebook=coalesce(facebook,'https://facebook.com/intimo.urbanonoche') where id='9746d8c0-7644-4495-8ff5-8e3f9dfe4ca4';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='2718178e-8a8e-4c63-a487-3cc8960aecd1';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/twins_dresses') where id='2e835642-a427-4f1d-969e-41269323e73b';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='6e2a3178-17d0-4675-b4d3-eb31a62757f7';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='16b37124-b4f3-4e39-b7c4-eab15ccfc83d';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='53248b3b-4d7f-4422-bdb1-c44b95891de6';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/thomasjfiedler'), facebook=coalesce(facebook,'https://facebook.com/ThomasJFiedlerOficial') where id='7339dfa3-1690-432d-8299-e48c3766b661';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='aa35f19e-8a88-41f1-acaf-2a9b6340041c';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='b0503079-e331-4778-b65d-ead87f04f86d';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/bellarose.alquiler'), facebook=coalesce(facebook,'https://facebook.com/Bellarosealquiler') where id='c557337c-914e-468b-9ba0-90c6928461cb';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/toiadekiev'), facebook=coalesce(facebook,'https://facebook.com/toiadekiev') where id='b842a0a1-ce52-434a-811c-7ed4c1557d62';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='0ca6945d-573a-42d7-ba61-0b776d2360ca';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='4525212e-0e51-4c9a-95ea-01cc0f21a924';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='23afc504-efc0-476b-b1b3-2a2035b9ff78';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/latelierindumentaria'), facebook=coalesce(facebook,'https://facebook.com/2008') where id='d37ff302-72f0-4565-93c0-80f21ab141c0';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='060406af-bec4-41c1-85a0-706697d99e9c';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='d711c204-6bf1-4924-ab83-27ad423d4fbf';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/designplusmoda'), facebook=coalesce(facebook,'https://facebook.com/designplusmoda') where id='a2a310cb-cd0f-44e2-a9bc-3cb4b7d06285';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='f9ab679e-56ec-4713-a8bf-987d3f09e01a';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/boutiquegalatea'), facebook=coalesce(facebook,'https://facebook.com/vestidosdenoviacostarica') where id='f7187dca-0292-4161-9670-6b3e6aff54aa';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/annarossattiok'), facebook=coalesce(facebook,'https://facebook.com/2008') where id='873bdfac-ad8a-41ab-902e-d317d8ff88a3';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/gloria_trevejos'), facebook=coalesce(facebook,'https://facebook.com/boutiquegloriatrevejos') where id='9e700550-5b8a-4013-be24-2bbe03148c79';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/cocoshao.oficial'), facebook=coalesce(facebook,'https://facebook.com/2008') where id='ad013ac5-f99a-4b78-b0b0-012f1509d755';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='a9ff8581-ecca-4463-9c2e-c19b5f011302';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='364620b8-e335-4c10-84c7-6c0ca6378829';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/aziravestidos'), facebook=coalesce(facebook,'https://facebook.com/aziravestidos') where id='c8068d5b-ae24-47d4-94a5-50dbead463a9';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/ellenavestidosfiesta') where id='2105467b-229f-4ab8-a938-68f9ac85b254';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='c8e272ad-749e-4fe4-b5bd-921c1833d5c3';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/1000razones'), facebook=coalesce(facebook,'https://facebook.com/milrazones') where id='8136e2dc-0b10-4528-a8d8-350f1cfc82bc';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='ba3d3fa3-5f66-4b88-9ab8-84660567e9f1';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='a8187680-f0ce-497f-b7e5-1fb680c51285';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/casamagaly'), facebook=coalesce(facebook,'https://facebook.com/casamagalycol') where id='bca7e2f2-bac3-4105-93d3-60203b0b1b04';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/kadrihel'), facebook=coalesce(facebook,'https://facebook.com/KADRIHEL') where id='df2fd708-4b0a-4c54-8f0e-8a2afa3d16e6';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/pronovias'), facebook=coalesce(facebook,'https://facebook.com/pronovias') where id='0b94f33d-d974-4f26-9dac-f485841b33c4';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='4ad7cf71-c575-4beb-bffa-405672549d24';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/catalina_bayona'), facebook=coalesce(facebook,'https://facebook.com/catalina.bayona.vestidos.de.novia') where id='ceb79c71-f05e-4ca2-88ef-0cf21a2c53bc';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='7ee9f17d-705c-40cb-837c-f9623a82159e';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='f7e0541b-f623-4336-8815-d30e3d3616c8';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='f96babaf-c413-4ba0-8ab9-d2768389b0bd';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/lemans.vestidos'), facebook=coalesce(facebook,'https://facebook.com/2008') where id='caf9c707-752c-48f3-8b3f-c03827f0b269';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='f0df3bee-94f3-4af9-9dfd-db2774178799';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/click2dress'), facebook=coalesce(facebook,'https://facebook.com/alquilerdevestidosclick2dress') where id='25bfec80-1872-4869-849d-5b2dea93d289';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='960a12d3-1226-4dba-b13c-f06b17a430fa';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/el_balcon_de_las_novias'), facebook=coalesce(facebook,'https://facebook.com/elbalcondelasnovias') where id='a2557e01-34e5-45b9-b98d-81c554bc9d9b';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/premier_novias') where id='c1044997-b2a1-443a-8cbf-4c7fd2bfc18d';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/encanto_accesoriosviarosa'), facebook=coalesce(facebook,'https://facebook.com/espacioviarosa') where id='53325ca6-49a0-4b00-ad25-f650864db077';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/nataliaarangonovias'), facebook=coalesce(facebook,'https://facebook.com/nataliaarangovestidosdenovia') where id='00d5da7f-6c98-46a4-8f87-420ed4a4a639';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='dc01f2a0-bd2b-4849-b18f-15ac9fd9416f';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='495e5665-2f60-40e3-b49b-608e1f2dd95f';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='248f9940-d626-4ed3-b9fc-f452b44f6698';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/nissipartydress'), facebook=coalesce(facebook,'https://facebook.com/nissipartydress') where id='fa3ac243-b75a-4b10-a54e-5ba26f0a0e04';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='e0fbcedf-0488-4a52-929f-bc437035e62c';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/xtampalo.impresion.textil'), facebook=coalesce(facebook,'https://facebook.com/XTAMPALOEXPLANADAPUEBLA') where id='fdbd1104-dc98-4e87-9e4b-6995ca80b761';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/kamelivestidos'), facebook=coalesce(facebook,'https://facebook.com/2008') where id='00b8b155-5276-49c1-811d-c5baeaaed872';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='4f6ae79e-788c-40ce-a92f-74036ca3c37e';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/investidasok'), facebook=coalesce(facebook,'https://facebook.com/2008') where id='fb2fbf56-53a9-4d63-b711-ae6a6ef9597c';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/esthercespedes_') where id='f049f04f-a5a9-41aa-ad6b-69ce28577a2e';
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/auravestidosok'), facebook=coalesce(facebook,'https://facebook.com/2008') where id='9e169b3d-1139-452b-a836-e03b1174eadd';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='2273a195-5525-452a-ab21-fbb3081f5f55';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='1f702ebe-e3bc-484d-8c71-8cbb6582af1b';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='a629ea05-2b86-4d0c-956d-f47d24c82e1b';
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='d9d2b893-ce8a-4612-b17b-45399075e516';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='6d79e35c-ac2e-4e2c-9edc-3bb03c31f3d8';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='6bfb9e84-c27e-4815-804c-91601d23f096';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='a0df1d9e-c599-496f-b572-aa637dc32e76';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='fc09d234-8606-4ce0-b5b7-441915bfdeb6';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='11a38a6e-81d8-4625-bc5b-4e67bc017665';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='2235d022-7e58-4ef2-a4f8-e6bdae34a604';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='8e7be1ff-e398-413f-81a4-d21ec08892cc';
...
update abm_cuentas set facebook=coalesce(facebook,'https://facebook.com/help') where id='1ba666c7-e797-4f63-bf5a-d051e2b71b6a';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/rivierezapateria'), facebook=coalesce(facebook,'https://facebook.com/1267459790095310') where id='f9fd990f-50eb-4ff0-a70f-0e312b1e9f47';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/tedbodin'), facebook=coalesce(facebook,'https://facebook.com/tedbodinoficial') where id='074f546d-9558-46a0-be84-bd608b897475';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/borda2yestampa2mx'), facebook=coalesce(facebook,'https://facebook.com/borda2yestampa2mx') where id='f97afd92-1762-473a-b0ee-b71536a77eb1';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/skerzodisfraces'), facebook=coalesce(facebook,'https://facebook.com/111708760300993') where id='09782e00-2f2a-45f9-b5fd-112b8b9cfa00';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/LIVE123'), facebook=coalesce(facebook,'https://facebook.com/LIVE123') where id='fba8bc3c-8179-4e36-b231-af5cc0a7cbfb';
...
update abm_cuentas set instagram=coalesce(instagram,'https://instagram.com/LaRemolachaCancun'), facebook=coalesce(facebook,'https://facebook.com/laremolachacancun') where id='60bc1994-8f56-46b3-a815-0403077df369';
