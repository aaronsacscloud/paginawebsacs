...
const DEFAULT_TEMPLATES: Record<string, any> = {
  embajador: {
    ...
    compromisos: [
      ...
      { title: 'Generar 100 puntos al mes con contenido y acciones', detail: 'Cada mes generas mínimo 100 puntos a través de contenidos y acciones de marketing o actividades filantrópicas vinculadas a SACS. Estas acciones las subes tú mismo desde tu panel de partner para que se contabilicen — esa es la señal que nos confirma que sigues activo en el programa. Si no se reportan en el panel, no se acreditan puntos ni se mantienen los beneficios. Si haces más de 100, los puntos extra se acumulan al siguiente mes.', frequency: 'Mensual · 100 pts' },
      ...
      { title: 'Publicar en tus redes sociales',             detail: 'Publicar el contenido en tus propias redes (Instagram, TikTok, YouTube o LinkedIn) y compartirlo con tu audiencia.', frequency: 'Continuo' },
      ...
      { title: 'Sesión mensual de actualizaciones SACS',     detail: 'Asistir cada mes a una sesión de 30-60 minutos donde el equipo de producto presenta lo nuevo del sistema.', frequency: 'Mensual' },
    ],
    tabulador: {
      prueba_gratis: 250,
      demo_completada: 300,
