...
1. VENDE ($810 MXN/mes, $527/mes pagando anual) — Para marcas que arrancan su primera tienda.
...
2. CONTROLA ($1,215 MXN/mes, $790/mes pagando anual) — Para marcas con varias sucursales.
   - Todo de Vende +
...
3. FIDELIZA ($1,890 MXN/mes, $1,229/mes pagando anual) — Para marcas que quieren clientes que regresan.
   - Todo de Controla +
...
4. AUTOMATIZA ($3,780 MXN/mes, $2,457/mes pagando anual) — Operación en piloto automático con IA.
   - Todo de Fideliza +
