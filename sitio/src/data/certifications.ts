...
export const CERTIFICATIONS: Certification[] = [
  {
    id: 'demos_consultoria_consciente',
    nombre: 'Certificación · Demos SACS con Consultoría Consciente',
    shortName: 'Demos · Consultoría Consciente',
    precio: 350000,
    precioMostrar: '$3,500',
    duracion: '4 horas en vivo + manual de método + 2 demos en role-play',
    nivel: 'Inicial · Obligatoria',
    cover: '/images/certificaciones/demos-consultoria-consciente.webp',
    descripcion: 'Aprende el método SACS de Consultoría Consciente para hacer demos del sistema en vivo — videollamada o presencial. Estructura conversacional, qué preguntar, qué mostrar de SACS según el tipo de negocio, y cómo cerrar con propuesta. Al certificarte desbloqueas la posibilidad de capturar leads directos en tu portal (clientes que tú mismo conociste, sin link).',
    paraQuien: 'Todo partner que quiera presentar SACS de manera profesional. Es la cert obligatoria para registrar leads directos (visitas físicas o llamadas que tú mismo hiciste) en lugar de solo via link compartido.',
    temario: [
      'El método Consultoría Consciente: escucha activa, diagnóstico, propuesta',
      'Estructura de una demo SACS de 30 min · timing y secuencia',
      'Cómo abrir: las 5 preguntas clave para entender el negocio del cliente',
      'Qué mostrar de SACS según el giro (retail físico, multi-sucursal, e-commerce, servicios)',
      'Cómo manejar objeciones típicas (precio, miedo al cambio, migración de datos)',
      'Cierre con propuesta: armar el paquete (plan + implementación + servicios)',
      '2 demos en role-play con feedback grabado',
      'Manual del método en PDF + checklist de pre-demo',
    ],
    beneficios: [
      'Diploma + badge "Consultoría Consciente" en tu portal',
      'Desbloqueo de la función "Agregar lead directo" en el portal',
      'Manual del método (PDF, 28 páginas)',
      'Plantilla de propuesta editable post-demo',
      'Acceso a sesión mensual de calibración con el equipo SACS',
      'Tu primera demo asistida con un Partner Manager (60 min)',
    ],
    serviceChargeMin: 0,
    serviceChargeMax: 0,
    serviceChargeMostrar: 'Habilitación · sin cargo al cliente',
    serviceModel: 'one-time',
    serviceUnit: '/ habilita tu portal',
  },
  {
