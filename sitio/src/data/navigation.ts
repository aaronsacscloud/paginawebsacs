...
export const businessSectors: BusinessSector[] = [
  ...
  },
  {
    ...
    personalizations: [
      ...
      { label: 'La talla agotada se apaga sola', description: 'La última S se vende una vez — y desaparece de todos los canales al segundo.' },
      ...
      { label: 'La comunidad que vuelve', description: 'Perfil con tallas y colorways, monedero y puntos, campañas de restock por WhatsApp.' },
      { label: 'Apartados y preventa', description: 'La que quiere asegurar su talla aparta con anticipo y recoge o recibe.' },
