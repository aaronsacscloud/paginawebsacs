...
export const businessSectors: BusinessSector[] = [
  {
    ...
    personalizations: [
      ...
      { label: 'Matriz de tallas y colores', description: 'Captura y surte en cuadrícula talla × color: ves de un vistazo qué combinación tienes, cuál se agotó y cuál nunca se vendió.' },
  ...
  },
  {
    ...
    personalizations: [
      ...
      { label: 'Consigna vs firme', description: 'El inventario separa lo tuyo de lo que el proveedor te dejó, con el corte para liquidarle. Es la Suite de Consignación, se cotiza aparte.' },
      { label: 'Margen por marca', description: 'Costeo y utilidad por prenda, leídos por marca: sabes cuál te deja y cuál solo ocupa percha.' },
      { label: 'Tallas y colores', description: 'Variantes por talla × color con existencia propia, igual que en cualquier tienda de moda seria.' },
      { label: 'Looks de varias marcas', description: 'El vestido de una marca y el bolso de otra, como kit en un solo ticket.' },
      { label: 'Apartados con abonos', description: 'Anticipo, parcialidades y recordatorios — el apartado clásico de boutique.' },
      { label: 'Cambios y vales', description: 'Cambio de talla o color y vale a favor, aunque la prenda venga de otra tienda.' },
      { label: 'Resurtido por rotación', description: 'Reabasto sugerido por marca según lo que de verdad rota — para llegar a la expo con datos.' },
    ],
  },
  {
    ...
    personalizations: [
      ...
      { label: 'Estado de cuenta por consignante', description: 'Qué se vendió, cuánto le toca y qué sigue colgado — su portal se lo dice solo, sin que te llame.' },
      { label: 'Saldo a favor', description: 'La mayoría prefiere dejar su dinero como saldo y estrenar de tu tienda. Se acumula, se gasta o se retira.' },
      { label: 'Lives y dinámicas', description: 'Programa el Live, asigna piezas y mide qué se vendió y cuánto convirtió. La vendida se baja sola de todos los canales.' },
      { label: 'Autenticidad y disputas', description: 'La pieza dudosa se bloquea: no se vende ni se aparta hasta resolverse. La no auténtica sigue su propio camino.' },
      { label: 'Piezas únicas', description: 'SKU único con foto, condición y medidas. El apartado bloquea la pieza de verdad: nadie la vende dos veces.' },
      { label: 'Retiros y vigencia', description: 'Al vencer el plazo, armas la lista de retiro en un clic: qué piezas, dónde están y qué falta por liquidar.' },
      { label: 'Cobra como cualquier tienda', description: 'POS con o sin internet, apartados, ticket por WhatsApp, tienda en línea y redes con el mismo inventario.' },
    ],
  },
  {
  ...
  },
  {
    ...
    personalizations: [
      ...
      { label: 'Drops con un solo inventario', description: 'Tienda en línea, Instagram, Facebook y TikTok Shop venden el drop del mismo inventario. Sin sobreventa.' },
      { label: 'La talla agotada se apaga sola', description: 'La última S se vende una vez — y se apaga en todos los canales.' },
      { label: 'Cambio de talla sin drama', description: 'En tienda o por paquetería, contra inventario real; vale a favor o monedero si la talla ya voló.' },
      { label: 'El lote con datos', description: 'Reabasto sugerido por talla con la venta real del drop anterior. La curva deja de romper el set.' },
      { label: 'La comunidad que vuelve', description: 'Perfil con tallas y colorways, monedero y puntos, la lista de avísame y campañas de restock por WhatsApp.' },
      { label: 'Apartados', description: 'La que quiere asegurar su talla aparta con anticipo y recoge o recibe.' },
      { label: 'Showroom y bodega cuadrados', description: 'POS con o sin internet, cortes de caja, conteo desde el celular y kardex por drop.' },
    ],
  },
  {
    label: 'Zapaterías',
