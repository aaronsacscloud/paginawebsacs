...
export const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { category: 'Clientes y equipo', items: ['Directorio de clientes e historial de compras', 'Metas y comisiones por vendedor', 'Permisos por usuario y sucursal'] },
  ...
  },
  {
    ...
    features: [
      { category: 'Clientes y CRM', items: ['Perfil 360° del cliente con historial omnicanal', 'Segmentación por comportamiento de compra', 'Notas, seguimientos y actividad en tiempo real'] },
      { category: 'Programa de lealtad', items: ['Monedero electrónico y puntos por compra', 'Niveles y recompensas personalizadas', 'Redención en tienda física y en línea'] },
      { category: 'Portal de clientes y tarjetas de regalo', items: ['Portal de clientes personalizado con tu marca', 'Portal de autofacturación', 'Tarjetas de regalo físicas y digitales'] },
      { category: 'Marketing por correo', items: ['Campañas de email segmentadas', 'Plantillas personalizables', 'Hasta 1,000 contactos incluidos'] },
      { category: 'Marketing por WhatsApp', items: ['Notificaciones automáticas por WhatsApp', 'Campañas y promociones por WhatsApp', 'Hasta 200 contactos activos incluidos'] },
      { category: 'Membresías y suscripciones', items: ['Planes recurrentes para clientes frecuentes', 'Cobro automático y renovación', 'Beneficios exclusivos por nivel de membresía'] },
    ],
    services: [
      'Multi-sucursal',
      'Reunión mensual',
  ...
  },
  {
    ...
    monthly: { mxn: 5900, usd: 295, eur: 272, brl: 1534, cop: 1239000, ars: 265500, clp: 280250, pen: 1121, gbp: 234 },
    annual: { mxn: 4917, usd: 246, eur: 227, brl: 1278, cop: 1032500, ars: 221250, clp: 233542, pen: 934, gbp: 195 },
    annualTotal: { mxn: 59000, usd: 2950, eur: 2720, brl: 15336, cop: 12390000, ars: 2655000, clp: 2802500, pen: 11210, gbp: 2340 },
    highlighted: false,
    inheritsFrom: 'Fideliza y Multiplica',
    cta: { label: 'Inicia ahora', href: '/registro?plan=automatiza', variant: 'secondary' },
    features: [
      { category: 'Especialista IA dedicado', items: ['Una persona real que diseña tus automatizaciones contigo', 'Sesión mensual de optimización y nuevos workflows', 'Onboarding completo de tu operación con IA'] },
      { category: 'AXO · Copiloto IA', items: ['Pregúntale lo que quieras de tu negocio y actúa al instante', 'Detecta problemas antes de que pasen y te sugiere qué hacer', 'Aprende de tu operación y se vuelve más inteligente cada día'] },
      { category: 'Workflows', items: ['Automatiza tareas repetitivas con reglas trigger → acción', 'Stock bajo → genera orden de compra automática', 'Nueva venta → notifica, factura y actualiza inventario', 'Workflows a la medida para tu flujo específico de negocio'] },
      { category: 'Alertas inteligentes', items: ['Avisos proactivos de anomalías de venta y stock', 'Alertas de productos estancados y riesgo de quiebre', 'Notificaciones por WhatsApp o email en tiempo real'] },
      { category: 'Reportes predictivos', items: ['Reportes automáticos a la hora que elijas', 'Dashboards personalizados por rol (dueño, gerente, vendedor)', 'Predicción de demanda y tendencias con IA'] },
      { category: 'Orquestador de agentes', items: ['Conecta Claude, GPT y Gemini para ejecutar tareas complejas', 'Agentes de IA para reabasto, pricing y campañas en cadena', 'Especialista IA dedicado para diseñar tus automatizaciones'] },
      { category: 'API e integraciones', items: ['Conecta con +600 apps: ERP, contabilidad, logística, marketing', 'API abierta para integraciones a la medida', 'Tokens de IA incluidos, escala según necesites'] },
    ],
    services: [
      'Multi-sucursal',
