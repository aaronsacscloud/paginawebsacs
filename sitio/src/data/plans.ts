...
export const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { category: 'Qué se vendió y qué se quedó', items: ['50+ reportes de ventas, inventario y finanzas', '20+ indicadores de tu operación', 'ABC, rotación y sell-through por modelo, talla y tienda', 'Costo y utilidad por prenda', 'Auditoría de movimientos'] },
    ],
    services: [
      'Multi-sucursal',
  ...
  },
  {
    ...
    features: [
      ...
      { category: 'La temporada, ejecutada por la IA', items: ['Salud de la curva por color: qué modelo tiene hueco en el núcleo de tallas y cuál ya se rompió', 'La IA propone el traspaso que completa la corrida entre tiendas; tú apruebas', 'Resurtido y mínimos por tienda calculados solos, con la venta real y el mismo periodo del año pasado', 'Lo etiquetado como liquidación o fin de temporada deja de resurtirse en toda la red', 'Tope de presupuesto por temporada: prioriza por venta perdida al día y difiere lo que no entra', 'Aviso de prenda colgada antes de que se vuelva saldo', 'Presupuesto de compra pre-temporada y liquidación por semanas en piso: en camino'] },
