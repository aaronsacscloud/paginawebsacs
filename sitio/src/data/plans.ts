...
export const plans: Plan[] = [
  {
    ...
    highlighted: false,
    cta: { label: 'Inicia ahora', href: '/prueba-gratis', variant: 'secondary' },
    features: [
  ...
  },
  {
    ...
    cta: { label: 'Inicia ahora', href: '/prueba-gratis', variant: 'primary' },
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      { category: 'Integraciones', items: ['Más de 600 aplicaciones conectadas', 'Consumo de IA adicional según uso'] },
    ],
    services: [
      'Multi-sucursal',
