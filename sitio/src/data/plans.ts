...
export const plans: Plan[] = [
  {
    ...
    features: [
      { category: 'Piso de venta', items: ['Punto de venta con y sin internet', 'Pausa la venta mientras se prueba otra talla', 'Cambios de talla, devoluciones y cancelaciones', 'Cortes de caja y arqueos', 'Tickets por WhatsApp', 'Cotizaciones', 'Apartados con abonos y pedidos', 'Ventas a crédito', 'Listas de precios: menudeo y mayoreo', 'Precio de mayoreo por cantidad'] },
  ...
  },
  {
    ...
    features: [
      ...
      { category: 'Tus clientes y tus vendedores', items: ['Tus clientes, con lo que se han llevado', 'Metas y comisiones por vendedor', 'Permisos por persona y por tienda'] },
  ...
  },
  {
    ...
    description: 'Para que tu cliente regrese cada temporada, no una vez al año.',
    ...
    features: [
      { category: 'La ficha de tu cliente', items: ['La ficha de tu cliente: lo que compró en tienda y en línea', 'Agrupa a tus clientes por lo que compran', 'Notas y seguimientos de cada cliente'] },
...
export const comparisonCategories: ComparisonCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Recordatorio de abono a tu cliente', vende: false, controla: false, fideliza: true, automatiza: true },
      ...
      { name: 'Sugerencia de qué más ofrecerle al cliente', vende: false, controla: false, fideliza: false, automatiza: true },
    ],
  },
  {
  ...
  },
  {
    name: 'Tus clientes',
    features: [
      { name: 'Registro de tus clientes', vende: true, controla: true, fideliza: true, automatiza: true },
      { name: 'Lo que se ha llevado cada cliente', vende: true, controla: true, fideliza: true, automatiza: true },
      { name: 'Notas y seguimientos', vende: false, controla: true, fideliza: true, automatiza: true },
      { name: 'Cuánto te ha comprado cada cliente', vende: false, controla: true, fideliza: true, automatiza: true },
      { name: 'Ficha completa de tu cliente', vende: false, controla: false, fideliza: true, automatiza: true },
      ...
      { name: 'Grupos de clientes por lo que compran', vende: false, controla: false, fideliza: true, automatiza: true },
    ],
  },
  {
...
export const pricingFaqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Todo sigue disponible 90 días después de cancelar. Exportas cuando quieras tus modelos con sus tallas y colores, tu cartera de clientes y tu historial de ventas. No hay cargo por cancelar.',
  },
  {
