...
export const GIFT_LICENSE_VALUE_MXN = 6318;

// Bono al padrino cuando su amigo activa el año gratis = 40% de la licencia ($2,527).
...
// licencia ($2,527 fijo, NO del monto descontado) en créditos Sacs.
