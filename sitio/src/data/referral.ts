...
export const GIFT_LICENSE_VALUE_MXN = 8100;

// Bono al padrino cuando su amigo activa el año gratis = 40% de la licencia ($3,240).
...
// licencia ($3,240 fijo, NO del monto descontado) en créditos Sacs.
