...
export const pasosWS = [
  ...
  { cuando: 'Día 2', titulo: 'Tu operación, configurada', texto: 'Queda como ya trabajas: tus fábricas, tu taller, tus plazas y tus vendedores.', detalle: 'Precio de feria, comisión por par y por conjunto, la regla de los apartados y quién autoriza un traspaso.', img: `${IMG}/proceso-direccion.webp`, alt: 'Dueño y comprador de una cadena western configurando plazas, comisiones y precios de feria frente al tablero' },
  { cuando: 'Día 3', titulo: 'Capacitación', texto: 'Una sesión con tu equipo antes de abrir. Escanear un par y ver dónde hay el número se aprende en media hora.', detalle: 'Y se practica lo de todos los días: el apartado, el traspaso, el hormado en el ticket y el conjunto.', img: `${IMG}/proceso-conjunto.webp`, alt: 'Vendedor armando el conjunto de un joven frente al espejo con el ticket de cinco líneas en la tablet' },
  { cuando: 'Día 4', titulo: 'Arranca una tienda', texto: 'La primera sucursal vende con Sacs. El sistema viejo sigue en pie por si acaso.', detalle: 'Con los apartados vivos ya migrados: nadie llega a liquidar su par y se encuentra con que su libreta no existe.', img: `${IMG}/proceso-piso.webp`, alt: 'Vendedora atendiendo a un cliente que se prueba botas de avestruz, con los números en la tablet el primer día' },
  { cuando: 'Día 5', titulo: 'Arrancan las demás', texto: 'Con la primera resuelta, las otras entran el mismo día.', detalle: 'Y el traspaso de números entre plazas ya corre desde el primer fin de semana, que es cuando se nota.', img: `${IMG}/proceso-traspaso.webp`, alt: 'Empleado entregando cajas de bota y una caja de texana a la camioneta de la cadena para el primer traspaso entre plazas' },
];
