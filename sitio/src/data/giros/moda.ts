...
export const marcacionModa = {
  ...
  prendas: [
    {
      ...
      accion: 'No se marca: se vende sola',
      tono: 'ok',
  ...
  feo: {
    ...
    detalle: 'Va en 23% en la semana 8. Ya se marcó al 20% en la semana 4 y no reaccionó: salieron cuatro en tres semanas. Al 50% se van unas veinte antes de que cierre la temporada, y las otras cuarenta y cinco salen en julio al 70% — a $447 la pieza contra $515 que costó.',
