...
export const marcacionModa = {
  ...
  prendas: [
    {
      ...
      accion: 'No le bajes: se está vendiendo',
      tono: 'ok',
      nota: 'Va quince puntos arriba de donde debería y sale 4.5 a la semana: las 22 que quedan se acaban solas en las cinco semanas que faltan. Meterle el 30 es regalar margen sobre algo que ya se estaba vendiendo solo.',
      dif: 8514,
      cuenta: '22 piezas × $387 de descuento (30% de $1,290) = $8,514 regalados sobre prenda que se vendía completa.',
    },
    {
      id: 'blusa',
      ...
      talla: 'Corazón vivo · faltan M y L en Polanco',
      accion: 'No le bajes: es básico',
      tono: 'ok',
      nota: 'Al básico no se le pregunta en cuánto va de la temporada: se le pregunta para cuántas semanas alcanza. Se vende todo el año y se repone. Un sistema genérico lo manda a rebaja por antigüedad — son cuarenta piezas de margen regaladas.',
      dif: 10788,
      cuenta: '40 piezas que salen en cinco semanas × $270 de descuento (30% de $899) = $10,788.',
    },
    {
      id: 'saco',
      ...
      accion: 'Métele el 30',
      tono: 'marca',
      nota: 'Veintisiete puntos abajo de donde debería y le quedan cinco semanas, pero conserva el corazón de la talla: todavía se puede vender. Aquí sí conviene meterle: al doble de ritmo salen quince en lugar de siete, y el margen por pieza aguanta.',
      dif: 0,
      cuenta: 'Sin marcar salen 7 × $1,300 de margen = $9,100. Al 30% salen 15 × $703 = $10,545. Marcar gana $1,445 y saca ocho piezas más.',
    },
    {
      id: 'falda',
      ...
      talla: 'Completa',
      accion: 'No le bajes: cámbiala de tienda',
      tono: 'traspaso',
      nota: 'León tiene 26 de las 42 piezas y saca una por semana; Polanco tiene 3 y saca cinco. No es problema de precio: es que están en la tienda equivocada. Veinte piezas de León a Polanco y salen a precio de lista.',
      dif: 20982,
      cuenta: 'Con el traspaso y sin marcar salen 41 × $780 = $31,980. Marcando parejo sin mover nada, León solo coloca 10: 26 × $423 = $10,998. Diferencia $20,982.',
      reparto: [
    ...
    },
    {
      ...
      accion: 'Ya es esqueleto: sácala del piso',
      tono: 'esqueleto',
      nota: 'Va en 80% y parece un exitazo, pero ya se le fue el corazón de la talla. A un esqueleto no lo salva el descuento: las cinco del centro se juntan en una tienda y las diecinueve puntas se van a saldo.',
      dif: 1372,
      cuenta: 'Las 5 del centro a precio ($1,795) más 19 a outlet ($1,606) = $3,401. Marcando parejo salen 8 y las otras 16 se liquidan más abajo = $2,028. Diferencia $1,373.',
    },
  ],
  ...
  feo: {
    ...
    detalle: 'Va en 23% en la semana 8. Ya se marcó al 20% en la semana 4 y no reaccionó: salieron cuatro en tres semanas. Al 50% se van unas veinte antes de que cierre la temporada; las otras cuarenta y cinco salen en julio al 70%, a $447 la pieza contra los $515 que costó.',
  ...
  pasos: ['Se lee', 'Se acomoda', 'Se autoriza', 'Se programa', 'Se remarbeta', 'Se mide'],
  pasosDetalle: [
    ...
    'La gerente de tienda. Marbetes nuevos con su código de barras, la prenda se reagrupa y se separa del piso a precio — lo rebajado se come a lo que está a precio si duermen juntos.',
    'El sistema, dos semanas después. Cuántas piezas salieron y a qué margen. La que no se movió con el 30 no se mueve con el 40: esa se va completa a liquidación.',
  ],
};
