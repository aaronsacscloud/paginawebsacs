...
export const variantesLE = {
  ...
  remate: 'Nueve huecos, y siete son del centro: 34B, 34C, 36B, 36C, 36D, 38C. Lo que queda son 32A y 40DD. Eso es una corrida rota, y se ve aquí antes de que la clienta pregunte.',
};
...
export const escalaLE = [
  ...
  { n: '150 tiendas', nombre: 'La cadena nacional', cambia: ['Regiones con supervisoras; la misma regla de higiene y cambio en todas', 'La corrida se planea por grupo de tiendas: el norte con números grandes, el centro con copas medias', 'Catálogo y tienda física con inventarios separados y la misma clienta'], sistema: ['Reposición por celda con mínimos y máximos por tienda', 'Auditoría de cambios rechazados por higiene y de mermas por sucursal', 'Qué copa vende cada colonia de México, en una pantalla'], dato: { valor: '1 ficha', rotulo: 'por clienta, con su número y copa, sin importar en qué tienda compró' } },
];
