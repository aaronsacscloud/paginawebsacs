...
export const casosOP = [
  ...
  },
  {
    ...
    alt: 'Optometrista entregando su caja de lentes de contacto a un cliente joven en el gabinete de una óptica',
  },
];
...
export const pasosOP = [
  ...
  { cuando: 'Día 4', titulo: 'Arranca una sucursal', texto: 'La primera óptica vende con Sacs. El sistema viejo sigue en pie por si acaso.', detalle: 'Con las órdenes vivas y el cajón de listos ya migrados: ningún cliente llega por sus lentes y se encuentra con que su orden no existe.', img: `${IMG}/proceso-entrega.webp`, alt: 'Vendedora ajustando los lentes nuevos en la cara del cliente con el calentador y recabando la firma del acuse' },
