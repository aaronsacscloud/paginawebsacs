...
| Activewear | **Al día y aprobada** (oficio/calidad con fixes verificados · diseño 9, 4 rondas). Bloque propio `ActiveSet` (el set que se rompe); pantallas con paleta forzada |
