...
export const pageContent: Record<string, any> = {
  "punto-de-venta": {
    ...
    "blocks": [
      {
        ...
        "bullets": [
          {
            "label": "En cualquier lugar de la tienda",
            "detail": "Tablet, celular o PC — atiendes junto al probador, en el piso de venta o donde el cliente esté."
          },
          {
            "label": "Venta consultiva al instante",
            "detail": "Consulta stock, muestra fotos y fichas, y recomienda según el historial de compra del cliente."
          },
          {
            "label": "Cobra como el cliente prefiera",
            "detail": "Tarjeta, efectivo, SPEI, OXXO o transferencia — cierras la venta en el mismo dispositivo donde la iniciaste."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "Pedido directo al POS correcto",
            "detail": "Apenas el cliente confirma en la tienda online, el pedido aparece en la sucursal que eligió."
          },
          {
            "label": "Inventario sincronizado",
            "detail": "Lo que se vende online descuenta en tiempo real del stock físico de esa sucursal."
          },
          {
            "label": "Entrega con QR",
            "detail": "El cliente muestra su QR, lo escaneas, se cierra el pedido. Sin verificar ID ni capturar datos a mano."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "Stock global",
            "detail": "Consulta inventario de todas las sucursales sin salir del POS."
          },
          {
            "label": "Traspaso 1-click",
            "detail": "Agenda envío o traspaso al momento, sin llamadas entre tiendas."
          },
          {
            "label": "Venta asegurada",
            "detail": "Cobras ahora aunque el producto esté en otra sucursal."
          }
        ]
      },
      {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "Sí. Cada vendedor puede tener su propia sesión con permisos específicos. Los cortes de caja son individuales por cajero o por turno."
      },
      {
        "question": "¿Cómo recibe el ticket mi cliente?",
        "answer": "Puedes enviar el ticket por WhatsApp, email o imprimirlo. La opción de WhatsApp es la más popular: rápida, sin papel y el cliente siempre lo tiene a la mano."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Genera CFDI directamente desde el POS al momento del cobro, o deja que tu cliente se autofacture desde el portal de clientes."
      }
    ]
  },
  "promociones": {
    ...
    "blocks": [
      {
        ...
        "bullets": [
          ...
          },
          {
            ...
            "detail": "Producto, categoría, horario, sucursal, tipo de cliente. Configura una vez, corre solo. Cambia una regla y se actualiza en todas las cajas al instante."
          },
          {
      ...
      },
      {
        ...
        "link": {
          "label": "Ver reportes de promociones",
          "href": "/producto/reportes-y-analitica"
        },
        "featured": true,
        ...
        "bullets": [
          {
            "label": "Por horario exacto",
            "detail": "Define hora de inicio y fin al minuto. La promo se prende y apaga sola — ideal para empujar ticket en hora pico o mover stock al cierre."
          },
          {
            "label": "Recurrencias inteligentes",
            "detail": "Diaria, semanal por días, mensual por patrón (\"segundo martes\") o cada N días. Configura una vez, corre por meses sin tocar nada."
          },
          {
            "label": "Por sucursal selectiva",
            "detail": "Activa la promo solo donde la necesitas — sucursales Norte, tiendas con sobre-stock, ubicaciones turísticas. Sin afectar el resto de la cadena."
          }
        ]
      },
      {
        ...
        "bullets": [
          ...
          },
          {
            ...
            "detail": "Liga el código a un cliente o segmento. Aunque circule en redes, solo cobra el descuento quien tú decidiste — bienvenida, VIP, recuperación."
          },
          {
            "label": "Trackeo por campaña",
            "detail": "Cada código deja huella. Mides cuántas ventas trajo cada influencer, cada email blast, cada anuncio — y replicas lo que sí funcionó."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "Cada promo, una recompensa",
            "detail": "En vez de descuento, el beneficio puede ser puntos extra al monedero del cliente. Misma campaña, mejor margen y más razón para volver."
          },
          {
            "label": "Acumulación inteligente",
            "detail": "Define multiplicadores por categoría, marca o segmento. Cliente VIP gana 3x, cliente nuevo 2x — todo configurado en una pantalla."
          },
          {
            "label": "Recompra medible",
            "detail": "Mides cuántos clientes regresaron a canjear, en cuántos días y cuánto gastaron — no solo el descuento del primer ticket."
          }
        ]
      }
    ],
    ...
    "faqs": [
      {
        "question": "¿Puedo correr una promo solo en sucursales específicas?",
        "answer": "Sí. Al crear la promo eliges una, varias o todas las sucursales. El motor valida que el descuento solo aplique en las tiendas seleccionadas — el cajero no puede equivocarse."
      },
      {
        "question": "¿Se aplica automáticamente o el cajero mete código?",
        "answer": "Ambas. Las promos basadas en reglas (producto + horario + sucursal + cliente) se aplican solas al cobrar. Las campañas exclusivas usan un código alfanumérico que el cajero captura."
      },
      {
      ...
      {
        "question": "¿Puedo combinar promociones con puntos de lealtad?",
        "answer": "Sí. El beneficio de una promo puede ser puntos de lealtad en lugar de (o además de) descuento en efectivo. \"Gasta $500 y gana 300 puntos\" se configura en 30 segundos."
      },
      {
        "question": "¿Queda registro de qué promoción se aplicó a cada venta?",
        "answer": "Sí. Cada ticket guarda la promoción aplicada y el código que activó el descuento (si aplica). Eso permite reportes por campaña, por cliente y por sucursal — útil para auditoría y para medir qué promos realmente movieron el negocio."
      },
      {
  ...
  "apartados-y-pedidos": {
    ...
    "blocks": [
      {
        ...
        "bullets": [
          {
            "label": "Anticipo cobrado al instante",
            "detail": "Tarjeta, efectivo, SPEI o transferencia desde el POS. El % mínimo se valida por política y queda registrado en la cuenta del cliente."
          },
          {
            "label": "Stock bloqueado al segundo",
            "detail": "La pieza queda apartada en el inventario en cuanto firmas: deja de aparecer como vendible en piso, online ni en otra sucursal hasta que el apartado se cierre o expire."
          },
          {
            "label": "Ticket con QR, saldo y fecha límite",
            "detail": "Imprimes o envías por email un comprobante con QR único, monto pagado, saldo pendiente y vencimiento. El cliente regresa, escaneas y cierras la venta sin teclear nada."
          }
        ]
      },
      {
        ...
        "bullets": [
          ...
          },
          {
            ...
            "detail": "Cada abono actualiza el saldo y la barra de progreso en vivo. Si lo configuraste, la fecha límite se extiende automáticamente con cada pago — sin Excel, sin llamadas internas para confirmar."
          },
          {
            "label": "Conversión a venta sin re-capturar",
            "detail": "Al cubrir el saldo, el apartado se cierra solo y genera la venta formal con factura si aplica. El stock se libera, el ticket se imprime y el cliente sale con su producto."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "Stock global desde el POS",
            "detail": "Consultas en segundos qué sucursal tiene la talla exacta — Polanco, Santa Fe, Chapalita o CEDIS — sin llamar a otra tienda ni salir de la pantalla de venta."
          },
          {
            "label": "Traspaso 1-click",
          ...
          },
          {
            ...
            "detail": "Cuando la prenda llega a la tienda de retiro, el cliente recibe email (y WhatsApp cuando conectes tu línea) avisando que ya puede pasar a recoger."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "Anticipo que cubre tu exposición",
            "detail": "Tomas el pedido contra producto que aún no compras al proveedor. El % de anticipo lo defines tú — suficiente para asegurar que el cliente lo va a recoger sin que tu capital quede atado."
          },
          {
          ...
          },
          {
            ...
            "detail": "Al ingresar el producto al inventario, el aviso al cliente queda redactado y listo. Apruebas, sale por email y el cliente programa su retiro o entrega."
          }
        ],
    ...
    "faqs": [
      {
        "question": "¿Puedo cobrar distintos % de anticipo según el producto?",
        "answer": "Sí. Configuras políticas por categoría o por tipo de cliente. Por ejemplo: 20% para ropa, 50% para joyería y 100% para pedidos especiales bajo orden."
      },
      {
        "question": "¿Qué pasa si el cliente no termina de pagar en el plazo?",
        "answer": "El apartado pasa a estado \"vencido\". El stock se libera automáticamente y el anticipo queda como crédito en la cuenta del cliente o se retiene según tu política — tú decides al configurar."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Al apartar, el sistema ve stock global. Si el producto está en otra tienda, genera un traspaso y notifica a las dos sucursales. Cuando llega, el cliente recibe un WhatsApp automático."
      },
      {
        "question": "¿Cómo funcionan los pedidos especiales de productos que no están en catálogo?",
        "answer": "Los capturas con marca, modelo, talla y color — sin crear SKU permanente. Se conectan con la orden de compra al proveedor. Cuando el producto entra al inventario, el cliente recibe la notificación."
      },
      {
        "question": "¿Quién autoriza cancelar o extender un apartado?",
        "answer": "Cualquier acción sensible (cancelación, extensión de plazo, cambio de condiciones) requiere PIN o biométrico del supervisor. Todo queda en bitácora con usuario, fecha y motivo."
      },
      {
        "question": "¿Se puede cancelar un apartado con retención parcial del anticipo?",
        "answer": "Sí. Configuras la política por tipo de producto o cliente: retención total, porcentaje de penalización, o conversión del saldo a crédito en la cuenta del cliente. Al cancelar, el sistema aplica la regla automáticamente."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Configuras un máximo de apartados abiertos por cliente, por monto acumulado o por categoría. Si el cliente excede el tope, el sistema pide autorización del supervisor antes de crear un apartado nuevo."
      },
      {
        "question": "¿Los apartados se ven en el mismo reporte de ventas?",
        "answer": "No. Los apartados abiertos son un pasivo, no una venta. Se convierten en venta formal al completarse el pago. Hay reportes separados: apartados abiertos, por vencer, vencidos y convertidos."
      },
      {
        "question": "¿Cómo se ven los apartados en el inventario?",
        "answer": "El stock apartado queda marcado como \"reservado\" en el inventario de la sucursal correspondiente. No aparece como disponible para la venta, pero sí se diferencia del stock vendido — tienes tres lecturas claras: disponible, reservado, vendido."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Al abrir el apartado se genera un ticket que incluye cliente, productos, monto pagado, saldo, fecha de vencimiento y política. Lo imprimes o lo envías por email en el momento."
      }
    ]
  },
  "social-commerce": {
    ...
    "features": [
      ...
      },
      {
        ...
        "description": "Cada venta en social descuenta stock al segundo. Sin sobreventa, sin \"ya no tenemos\" después del cobro. El reporte unifica ventas físicas, online y sociales."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z\"/></svg>",
        "title": "Checkout por WhatsApp",
        "description": "El cliente arma el carrito en el chat, recibe link de pago de Stripe, paga y el ticket o factura le llega de regreso al mismo WhatsApp. La venta entra al POS como cualquier otra."
      },
      {
    ...
    "blocks": [
      {
        ...
        "featured": true,
        "variant": "social-whatsapp",
        "bullets": [
          {
            "label": "AXO atiende en WhatsApp 24/7",
            "detail": "Responde dudas de stock, talla y precio con tu catálogo en vivo. Cuando el cliente decide, arma el carrito y manda el link de pago — sin que tú abras el celular."
          },
          {
          ...
          },
          {
            ...
            "detail": "Apenas se cobra, el cliente recibe el ticket por WhatsApp y, si pide factura, el CFDI 4.0 timbrado en PDF y XML — todo en el mismo hilo de chat."
          }
        ]
      },
      {
        ...
        "bullets": [
          ...
          },
          {
            ...
            "detail": "Reels, Stories, posts y lives etiquetados directo a SKU. El cliente toca, compra y sale sin abrir tu tienda en línea."
          },
          {
      ...
      },
      {
        ...
        "bullets": [
          ...
          },
          {
            ...
            "detail": "Cuántas piezas se reservaron, cuántas se cobraron, cuántas volvieron al stock, ticket promedio del live — sin pegar Excel del moderador con el del POS."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "AXO entiende el mensaje",
            "detail": "\"¿Tienen el negro?\", \"¿En cuánto sale?\", \"¿Hacen envío a Mérida?\" — AXO responde con catálogo en vivo, precio actual y costo de envío."
          },
          {
            "label": "Carrito armado en la conversación",
            "detail": "Cuando el cliente decide, AXO arma el pedido, confirma talla y dirección, y envía el link de pago — todo dentro del DM o el comentario."
          },
          {
            "label": "Bitácora del vendedor virtual",
            "detail": "Cada conversación queda en el CRM como interacción de venta. Si el cliente vuelve, el siguiente vendedor (humano o AXO) ve el contexto completo."
          }
        ]
      }
    ],
    "testimonial": {
      "quote": "Vendíamos por DM con calculadora y captura manual. Las ventas se duplicaron cuando AXO empezó a contestar y a mandar links de pago — y el inventario por fin cuadró con lo que decía el sistema.",
      "name": "Valentina Restrepo",
      "role": "Fundadora",
      "company": "Atelier Mediterráneo",
      "stat": "3.4×",
      "statLabel": "más conversiones de DM a venta cerrada"
    },
    "interrupt": "Si tu cliente vive en el feed,",
    "interruptStrike": "tu venta tiene que vivir ahí también.",
    "showcaseTabs": [
      {
        ...
        "details": [
          ...
          },
          {
            ...
            "description": "Lo que está en el POS aparece en el catálogo de WhatsApp. Sin re-subir fotos, sin desincronización de precios."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"2\" y=\"5\" width=\"20\" height=\"14\" rx=\"2\"/><path d=\"M2 10h20\"/></svg>",
          ...
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"4\" y=\"4\" width=\"16\" height=\"16\" rx=\"2\"/><path d=\"M9 9h6M9 13h6M9 17h3\"/></svg>",
            "title": "Factura CFDI desde el chat",
            "description": "El cliente pide factura por WhatsApp, AXO le pregunta RFC y razón social, y el CFDI 4.0 llega timbrado al chat en menos de 2 minutos."
          },
          {
            ...
            "title": "Multi-agente con bitácora",
            "description": "Si el caso pasa a humano, el agente ve toda la conversación y el historial de compras del cliente. Sin re-preguntar nada."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M3 3v18h18\"/><path d=\"M7 14l4-4 4 4 5-5\"/></svg>",
            "title": "Reporte de WhatsApp ventas",
            "description": "Conversiones, tiempos de respuesta, tickets cerrados por AXO vs. por humano. Para saber qué automatizar más."
          }
        ]
      },
      {
        ...
        "details": [
          ...
          },
          {
            ...
            "title": "Tags en Reels y Stories",
            "description": "Producto etiquetado en cualquier publicación. El cliente toca y compra desde la red — el reporte sabe qué Reel vendió."
          },
          {
          ...
          },
          {
            ...
            "title": "Reporte por canal y por SKU",
            "description": "Qué Reel vendió, qué live convirtió, qué SKU funciona en TikTok pero no en Instagram. Decisiones con data, no con corazonadas."
          }
        ]
      },
      {
        ...
        "details": [
          {
            ...
            "description": "\"Precio\", \"lo quiero\", \"¿tienen?\", \"¿cuánto?\" — AXO sabe cuándo es comprador y cuándo no, y responde solo cuando hay intención clara."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z\"/></svg>",
            "title": "Respuesta privada al DM",
            "description": "AXO contesta el comentario público con un mensaje cordial y manda el link de pago al DM, sin saturar el feed con detalles de cobro."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"9\" cy=\"21\" r=\"1\"/><circle cx=\"20\" cy=\"21\" r=\"1\"/><path d=\"M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6\"/></svg>",
            "title": "Carrito armado en el chat",
            "description": "Pregunta talla, color, dirección y método de pago. Al final manda link Stripe listo para pagar — sin formularios externos."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M1 4v6h6M23 20v-6h-6\"/><path d=\"M20.49 9A9 9 0 005.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 013.51 15\"/></svg>",
            "title": "Recovery automático",
            "description": "Si el cliente abre el link y no paga, AXO le manda recordatorio en 30 minutos. Si tampoco paga, libera el stock al cabo de X horas."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z\"/></svg>",
            "title": "Plantillas por marca",
            "description": "Tono, saludo, emojis y cierre configurables por marca. Multi-RFC y multi-marca con su propia voz."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2\"/><circle cx=\"9\" cy=\"7\" r=\"4\"/><path d=\"M19 8v6M22 11h-6\"/></svg>",
    ...
    "testimonials": [
      {
        ...
        "initials": "VR",
        "color": "#c87a4a",
        "quote": "Antes los DMs se perdían entre 4 personas y un Excel. Ahora AXO contesta el 80% y nosotros cerramos el 20% complicado. Las conversiones de Instagram subieron 240% en 3 meses.",
        "name": "Valentina Restrepo",
        "business": "Atelier Mediterráneo",
        "location": "Colombia"
      },
      {
        "bg": "#0a0a0a",
    ...
    "comparison": {
      ...
      "rows": [
        {
          "label": "Catálogo unificado entre POS, e-commerce, TikTok, IG y WhatsApp",
          "values": [
            "full",
            "full",
            "partial",
        ...
        {
          "label": "WhatsApp Business con catálogo, carrito y cobro nativos",
          "values": [
            "full",
            "partial",
            "none",
        ...
        {
          "label": "Bot de IA que atiende DMs y comentarios con stock real",
          "values": [
            "full",
            "partial",
            "none",
        ...
        {
          "label": "Reserva de stock automática durante TikTok/IG Live",
          "values": [
            "full",
            "partial",
            "none",
        ...
        {
          "label": "Comisiones de TikTok Shop / Meta separadas en el reporte",
          "values": [
            "full",
            "full",
            "none",
        ...
        },
        {
          ...
          "note": "Si el cliente abre el link y no paga, AXO le manda recordatorio y libera el stock al cabo de X horas."
        },
        {
          "label": "Multi-marca / multi-RFC con voz y tono distintos por marca",
          "values": [
            "full",
            "partial",
            "none",
        ...
        {
          "label": "Reporte por canal: qué Reel, qué live, qué chat vendió",
          "values": [
            "full",
            "partial",
            "none",
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "AXO atiende preguntas frecuentes (stock, precio, talla, envío), arma carritos y manda links de pago. Cuando el cliente quiere algo más complejo (queja, regalo personalizado, nota especial), AXO escala a un humano con todo el contexto. La idea es que tu equipo se enfoque en cerrar ventas complicadas, no en contestar \"¿tienen el negro?\"."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. AXO entiende y contesta en el español de México, Colombia, Argentina, Chile, Perú y otros países de LatAm — con modismos y tono local. La voz se configura por marca: una boutique millennial puede tener un AXO con emojis; una joyería de lujo puede tener un AXO formal y sin emojis."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Si el cliente abre el link de pago y no completa el cobro, AXO le manda recordatorio personalizado a los 30 minutos (configurable). Si tampoco paga, segundo recordatorio al día siguiente y liberación del stock al cabo de las horas que tú definas."
      },
      {
        "question": "¿Si tengo varias marcas, AXO usa la misma voz para todas?",
        "answer": "No. Cada marca tiene su propio AXO con saludo, tono, emojis y plantillas distintas. Multi-RFC y multi-marca con voz diferenciada — útil cuando operas una marca de moda urbana con tono casual y otra de joyería de lujo con tono formal bajo el mismo grupo."
      },
      {
        "question": "¿Qué pasa si el cliente quiere hablar con un humano y no con AXO?",
        "answer": "En cualquier momento del chat el cliente puede escribir \"humano\", \"agente\" o palabras similares y AXO escala el caso al equipo. El agente ve toda la conversación previa, el historial de compras del cliente y puede tomar el chat con un clic — sin re-preguntar nada."
      },
      {
  ...
  "tienda-en-linea": {
    ...
    "blocks": [
      {
        ...
        "bullets": [
          {
            "label": "El cliente elige sucursal",
            "detail": "En el checkout ve disponibilidad por tienda y elige la más conveniente. El pedido queda apartado ahí mismo."
          },
          {
            "label": "Aviso automático al equipo",
            "detail": "La sucursal recibe el pedido en su POS para preparar. Cuando está listo, el cliente recibe email para pasar a recoger."
          },
          {
            "label": "Entrega con QR en un escaneo",
            "detail": "El cliente muestra su QR, escaneas y se cierra el pedido. Sin verificar ID a mano, sin pedirle datos."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "Una OC distribuye por sucursal",
            "detail": "Capturas la orden con la cantidad que va a cada tienda — Polanco, Roma, CEDIS — en un solo flujo. Sin Excels ni emails al CEDIS para repartir después."
          },
          {
          ...
          },
          {
            ...
            "detail": "Las piezas recibidas aparecen al instante en tu POS y en tu sitio, con el desglose por sucursal correcto. El cliente ve \"Polanco: 13\", no un número promediado."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "Estado del pedido en vivo · QR para recoger",
            "detail": "El cliente ve su pedido pasar de \"preparando\" a \"listo para recoger\" sin recargar la página. Cuando llega, escanea el QR y la entrega se cierra en un toque."
          },
          {
            "label": "Puntos de lealtad que se sienten",
            "detail": "Cada compra suma puntos visibles en el panel — con barra de progreso al siguiente nivel. El cliente sabe cuánto le falta para Gold o Platinum sin entrar al programa por separado."
          },
          {
            "label": "Productos recomendados según lo que compra",
            "detail": "Tu cliente entra y ve \"Para ti\" con piezas basadas en su historial real — no en un algoritmo genérico. Aumenta el ticket promedio sin que abras una sola campaña."
          }
        ]
      },
      {
        ...
        "bullets": [
          {
            "label": "Físico, online y ambos lado a lado",
            "detail": "Una sola vista con tres KPIs comparables: cuánto vendiste en piso, cuánto en tu sitio y cuánto en ambos. Sin exportar a Excel ni cruzar dos sistemas — el corte ya está hecho."
          },
          {
            "label": "Por SKU, no sólo por totales",
            "detail": "Para cada producto ves cuántas unidades se movieron en cada canal. Distingues los que sólo crecen online, los que sólo se mueven en piso y los que venden parejo en los dos."
          },
          {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "Stripe Connect como base (tarjeta, Apple Pay, Google Pay, OXXO Pay, SPEI y métodos locales según país). Integraciones con Mercado Pago, Kushki, Wompi y dLocal están en roadmap según demanda de región."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Al hacer checkout elige la sucursal donde quiere retirar. La sucursal recibe el pedido en su POS, lo prepara y envía aviso al cliente cuando está listo."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Marcas un SKU como \"exclusivo web\" y no aparece en el POS físico. Útil para bundles, preventas, edición limitada o kits especiales."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Editor visual para hero, paleta, tipografías, secciones y orden de productos. Si necesitas algo muy custom, accedes al CSS o contratas a tu diseñador."
      }
    ]
  },
  "agentic-commerce": {
    "hero": {
      ...
      "video": {
        "mp4": "/videos/agentic-hero.mp4",
        "webm": "/videos/agentic-hero.webm"
      },
      "videoPoster": "/videos/agentic-hero-poster.webp"
    },
    "features": [
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"11\" cy=\"11\" r=\"8\"/><path d=\"M21 21l-4.35-4.35\"/></svg>",
        "title": "Discovery en motores de IA",
        "description": "ChatGPT Shopping, Gemini, Perplexity, Claude y Bing Copilot consultan tu catálogo cuando un usuario pregunta. Tus productos aparecen con foto, precio y link directo."
      },
      {
      ...
      },
      {
        ...
        "title": "Atribución por motor de IA",
        "description": "Reporte separado por ChatGPT, Gemini, Perplexity, Claude y Bing. Sabes qué IA te trajo cada visita y qué productos están funcionando en cada motor."
      }
    ],
    ...
    "blocks": [
      {
        ...
        "bullets": [
          ...
          },
          {
            ...
            "detail": "ChatGPT muestra el producto como una tarjeta clickable: imagen, nombre, precio actual y enlace que lleva al cliente directo a tu PDP — no a un buscador."
          },
          {
      ...
      },
      {
        ...
        "bullets": [
          {
            "label": "Schema en cada PDP",
            "detail": "JSON-LD válido en el HTML de cada página de producto. Lo que las IAs leen primero — y lo que decide si te citan o no."
          },
          {
      ...
      },
      {
        ...
        "bullets": [
          ...
          },
          {
            ...
            "detail": "Si tienes una promo activa, la IA muestra el precio con descuento — y aclara qué promo aplica. El cliente llega a tu sitio sin sorpresas."
          },
          {
      ...
      },
      {
        ...
        "bullets": [
          {
            "label": "Tráfico desglosado por IA",
            "detail": "ChatGPT, Gemini, Perplexity, Claude, Bing — cada visita queda etiquetada con el motor que la trajo. No hay que configurar UTMs a mano."
          },
          {
            "label": "Producto que disparó la visita",
            "detail": "Sabes en qué SKU cayó el cliente cuando llegó desde la IA — útil para entender qué descripciones funcionan en motores generativos."
          },
          {
            "label": "Comparación contra Google y social",
            "detail": "En el mismo dashboard ves cuánto te trae cada IA contra tus canales tradicionales. Mides el AEO contra el SEO sin hacer cuentas."
          }
        ]
      }
    ],
    "testimonial": {
      "quote": "Empezamos a aparecer en ChatGPT a las dos semanas de prender los feeds. Cuando alguien pregunta por botas de cuero en CDMX, salimos con foto y precio actual. Cero anuncios pagados, atribución limpia.",
      "name": "Mauricio Lara",
      "role": "Director Comercial",
      "company": "Calzados Libertador",
      "stat": "14%",
      "statLabel": "del tráfico viene de motores de IA"
    },
    "interrupt": "El cliente ya no busca en Google,",
    "interruptStrike": "le pregunta a una IA.",
    "showcaseTabs": [
      {
        "label": "Motores de IA",
        ...
        "details": [
          ...
          },
          {
            ...
            "title": "Gemini y Google AI Overviews",
            "description": "Feed XML para Merchant Center, schema.org en cada PDP, indexación automática. Tus productos aparecen en respuestas de Gemini, AI Overviews y Google Shopping."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"11\" cy=\"11\" r=\"8\"/><path d=\"M21 21l-4.35-4.35\"/></svg>",
            "title": "Perplexity Shopping",
            "description": "API y feed estructurado. Perplexity cita tus productos con link directo cuando responde preguntas de retail — incluyendo su propio módulo de checkout."
          },
          {
            ...
            "title": "Claude vía MCP server",
            "description": "Servidor MCP propio expone tu catálogo a Claude y a cualquier agente que lo consulte. Stock, precio y disponibilidad en vivo, sin integración por marca."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"12\" cy=\"12\" r=\"10\"/><path d=\"M12 6v12M6 12h12\"/></svg>",
            "title": "Bing Copilot",
            "description": "Microsoft Merchant Center sincronizado. Resultados de compra en Copilot dentro de Edge, Windows y la barra del sistema operativo."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M3 3h18v18H3z\"/><path d=\"M9 9l6 6M15 9l-6 6\"/></svg>",
            "title": "TikTok Shop y Meta Catalog",
            "description": "Mismos feeds alimentan TikTok Shop y Meta Catalog para WhatsApp Business e Instagram Shopping. Una sola fuente para todos los canales conversacionales."
          }
        ]
      },
      {
        ...
        "details": [
          {
            ...
            "title": "schema.org/Product en cada PDP",
            "description": "JSON-LD válido en el HTML de cada página de producto. Precio, disponibilidad, marca, GTIN, categoría, reseñas — todo lo que las IAs necesitan para citar correctamente."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z\"/><polyline points=\"14 2 14 8 20 8\"/></svg>",
            "title": "Feed Google Merchant Center",
            "description": "XML estructurado, atributos completos, validación nightly. Tus productos elegibles para Google Shopping, AI Overviews y Gemini sin pasos manuales."
          },
          {
            ...
            "title": "Feed Meta y TikTok",
            "description": "Catalog API de Meta y TikTok Shop conectados al mismo catálogo maestro. Descripciones, variantes, imágenes y promos alineadas en todos lados."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M21 12a9 9 0 11-18 0 9 9 0 0118 0z\"/><path d=\"M12 3v18M3 12h18\"/></svg>",
            "title": "OpenAI Product Feed",
            "description": "Spec del programa de comercio de ChatGPT. Tus productos quedan elegibles para aparecer en respuestas con shopping intent — y para los próximos motores que adopten el mismo formato."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"4\" y=\"4\" width=\"16\" height=\"16\" rx=\"2\"/><path d=\"M8 8h8v8H8z\"/></svg>",
            "title": "MCP Server (Model Context Protocol)",
            "description": "Servidor MCP propio para tu marca. Cualquier agente IA — Claude, ChatGPT custom, Gemini Agents — puede consultar tu catálogo en vivo con un endpoint estándar."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M22 11.08V12a10 10 0 11-5.93-9.14\"/><path d=\"M22 4L12 14.01l-3-3\"/></svg>",
            "title": "Validación continua",
            "description": "Cada cambio de catálogo dispara validación contra schema.org, Google Merchant y OpenAI specs. Si algo se rompe, alerta antes de que llegue al motor."
          }
        ]
      },
      {
        ...
        "details": [
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M20.59 13.41L13.42 20.58a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z\"/><circle cx=\"7\" cy=\"7\" r=\"1\"/></svg>",
            "title": "Etiqueta por motor de IA",
            "description": "ChatGPT, Gemini, Perplexity, Claude, Bing — cada visita identificada por su origen. UTM extendido + detección de user agent y referrer en cada landing."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"11\" cy=\"11\" r=\"8\"/><path d=\"M21 21l-4.35-4.35\"/></svg>",
            "title": "Producto consultado en la IA",
            "description": "Sabes qué pregunta hizo el cliente a la IA antes de aterrizar en tu sitio. Útil para entender qué descripciones y atributos funcionan en motores generativos."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M3 3v18h18\"/><path d=\"M7 14l4-4 4 4 5-5\"/></svg>",
            "title": "Conversión por motor",
            "description": "Funnel separado: visitas → producto → carrito → cobro. Comparas qué motor convierte mejor y para qué tipo de producto."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"3\" y=\"3\" width=\"18\" height=\"18\" rx=\"2\"/><path d=\"M3 9h18M9 21V9\"/></svg>",
            "title": "Comparación con Google y social",
            "description": "Mismo dashboard te muestra cuánto te trae cada IA contra Google orgánico, Meta Ads, social orgánico. Mides cuánto vale el AEO contra todo lo demás."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 2l3 7 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1z\"/></svg>",
            "title": "Top productos por motor",
            "description": "Sabes qué SKUs aparecen más en cada motor. Si una bota está pegando en Perplexity pero no en ChatGPT, ajustas la descripción para igualar el desempeño."
          },
          {
            "icon": "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M4 6h16M4 12h16M4 18h10\"/><path d=\"M18 15l3 3-3 3\"/></svg>",
            "title": "Exportable y vía API",
            "description": "CSV, webhook, BigQuery export. Si tienes un BI propio, los datos AEO entran como una fuente más — atribuibles a cada motor por separado."
          }
        ]
      }
    ],
    "testimonials": [
      ...
      },
      {
        ...
        "initials": "CB",
        "color": "#6a4cb3",
        "quote": "Lo primero que vi en el reporte fue 14% del tráfico de noviembre viniendo de Perplexity y ChatGPT. Ningún otro proveedor me dice eso — Google Analytics ya no alcanza para entender de dónde viene la venta.",
        "name": "Carolina Bravo",
        "business": "Boutique Oliva",
        "location": "Colombia"
      },
      {
        "bg": "#0a0a0a",
    ...
    "faqs": [
      {
        "question": "¿Qué es exactamente \"Agentic Commerce\"?",
        "answer": "Es la nueva forma de buscar y comprar: el cliente le pregunta a ChatGPT, Gemini o Perplexity en lugar de buscar en Google, y la IA consulta feeds estructurados antes de responder. Tus productos aparecen si tienes los feeds en su lugar — si no, no existes para esos motores."
      },
      {
      ...
      },
      {
        ...
        "answer": "ChatGPT Shopping (OpenAI), Google AI Overviews y Gemini (Merchant Center), Perplexity Shopping, Claude vía MCP server, Bing Copilot, TikTok Shop y Meta Catalog. La lista crece conforme nuevos motores publican specs públicas."
      },
      {
        "question": "¿Cuánto tarda en aparecer mi producto en una IA?",
        "answer": "Schema.org y JSON-LD: inmediato (apenas indexa Google, lo ven Gemini y AI Overviews). Google Merchant: 24–72 horas tras el alta. OpenAI Product Feed: 1–2 semanas tras alta. Perplexity: similar. Claude vía MCP: inmediato apenas la marca conecta su agente."
      },
      {
      ...
      },
      {
        ...
        "answer": "Los feeds son públicos por diseño — así funcionan los motores de búsqueda. Lo que no se copia: tu marca, tu storytelling, tu inventario, tus reseñas y tu atribución. Aparecer en la IA es un punto de partida, no la diferenciación."
      },
      {
        "question": "¿Cuánto cuesta?",
        "answer": "Está incluido en los planes Tienda en Línea y Omnicanal sin costo adicional. Los costos de las plataformas (Google Merchant es gratis, OpenAI por ahora también, Perplexity ofrece comisión por venta) se manejan directo entre tu marca y la plataforma."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. En el catálogo cada producto tiene un toggle de \"discoverable por IA\". Útil para excluir SKUs sensibles, productos de venta restringida o líneas que aún no quieres mostrar. Por defecto todo el catálogo público es discoverable."
      }
    ]
  },
  "facturacion-electronica": {
    ...
    "faqs": [
      ...
      {
        "question": "¿Con qué PAC se timbra?",
        "answer": "Integración directa con Facturama y Quadrum, los dos PACs autorizados por el SAT con los que arrancamos. Prodigia, FinKok y Edicom se agregan conforme los piden nuestros clientes. Si ya tienes contrato con otro PAC, evaluamos la integración en el onboarding."
      },
      {
      ...
      {
        "question": "¿Cómo funciona la autofacturación?",
        "answer": "Cada ticket lleva un QR. El cliente lo escanea, entra al portal con tu marca, captura RFC + régimen + uso del CFDI, y recibe el XML + PDF al correo. El cajero no interviene — el cliente hace el trabajo."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. CSV con folio, fecha, RFC, subtotal, impuestos, método y estatus. Compatible con Contpaqi, Aspel COI, ContaDimoni y el resto de los sistemas contables estándar en México."
      },
      {
  ...
  "inventario-omnicanal": {
    ...
    "faqs": [
      {
        "question": "¿El inventario se actualiza de verdad en tiempo real?",
        "answer": "Sí. Todas las transacciones (ventas, devoluciones, traspasos, ajustes) tocan la misma base de datos al momento. No hay cron nocturno de sincronización — el cambio se propaga en segundos a cada pantalla conectada."
      },
      {
        "question": "¿Puedo tener distintos costos por sucursal?",
        "answer": "Sí. Cada ubicación puede tener su propio costo de compra, costo promedio y costo de reposición. Los reportes de margen usan el costo de la sucursal donde ocurrió la venta."
      },
      {
        "question": "¿Cómo se maneja el stock reservado por apartados?",
        "answer": "La pieza pasa a estado \"reservado\" y desaparece del disponible. Si el apartado se convierte en venta, se descarga del inventario; si se cancela, regresa a disponible automáticamente."
      },
      {
        "question": "¿Qué pasa si dos cajeros venden el último producto al mismo tiempo?",
      ...
      },
      {
        ...
        "answer": "El ajuste requiere PIN del supervisor, un motivo obligatorio y queda en bitácora. Puedes filtrar el reporte mensual por tipo de motivo para detectar patrones — por ejemplo, merma recurrente en una sucursal específica."
      },
      {
      ...
      },
      {
        ...
        "answer": "No hay tope de ubicaciones en la arquitectura. Tenemos clientes operando desde 2 hasta decenas de sucursales en la misma base. La estructura soporta sub-ubicaciones (piso, bodega, showroom) dentro de cada tienda."
      }
    ]
  },
  "conteo-fisico": {
    ...
    "features": [
      {
        ...
        "title": "Captura rápida con Quick Scan o Excel",
        "description": "Busca el producto por código de barras, SKU o nombre y registra la existencia. Activa Quick Scan para teclear o escanear en serie sin parar, o importa un Excel con la plantilla que ya trae el código de barras y la columna de existencia."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M3 3v18h18\"/><path d=\"M7 14l4-4 4 4 5-5\"/></svg>",
    ...
    "faqs": [
      {
        "question": "¿Necesito comprar lectores de código de barras?",
        "answer": "No. La app usa la cámara del celular del equipo. Reconoce código de barras estándar, QR y códigos internos que imprimas en etiquetas. Si prefieres lector Bluetooth dedicado, la app también lo soporta."
      },
      {
        "question": "¿Funciona sin WiFi en la bodega?",
        "answer": "Sí. La app tiene modo offline — guarda los escaneos en el celular y los sube cuando vuelves al rango de WiFi. No pierdes nada aunque la bodega no tenga señal."
      },
      {
        "question": "¿Puedo contar mientras la tienda sigue abierta?",
        "answer": "Sí, con conteo cíclico por zonas. El sistema congela el stock de la zona mientras se cuenta y registra las ventas que ocurran ahí para ajustarlas al cerrar. Los conteos generales conviene hacerlos con la tienda cerrada."
      },
      {
        "question": "¿Qué pasa si cuento un SKU que no estaba en el teórico?",
        "answer": "Aparece como \"sobrante\" en el reporte. Decides si es un producto que llegó sin captura, un SKU mal registrado, o un error. Se ajusta con motivo y autorización."
      },
      {
      ...
      },
      {
        ...
        "answer": "Configuras umbrales por monto o por piezas. Ajustes por debajo los autoriza el gerente con PIN; por arriba requiere dirección. Cada ajuste queda con usuario autorizador, motivo y foto si la adjuntaste."
      },
      {
        "question": "¿Se pueden programar conteos cíclicos automáticamente?",
        "answer": "Hoy programas los conteos manualmente por zona y los abres cuando toca. La programación automática con rotación de zonas — \"cuenta pasillo A la primera semana, pasillo B la segunda\" — está en el roadmap."
      },
      {
        "question": "¿Qué reportes quedan después del conteo?",
        "answer": "Diferencias totales y por zona, valor a costo de lo sobrante y faltante, motivos agrupados, desempeño por contador, y tendencia histórica de mermas por sucursal. Todo exportable a Excel o PDF."
      },
      {
        "question": "¿Puedo hacer conteo en CEDIS y traspasos pendientes?",
        "answer": "Sí. El conteo físico funciona en CEDIS igual que en tienda. El stock en tránsito (traspasos entre ubicaciones) se separa en el reporte para no confundirse con las diferencias reales en piso."
      }
    ]
  },
  "nivelacion-de-inventario": {
    ...
    "features": [
      ...
      },
      {
        ...
        "title": "Mesa de decisión: tú apruebas línea por línea",
        "description": "Cada sugerido llega con clase ABC, nivel de confianza, días de cobertura y déficit. Filtras por sucursal o excepción, ajustas la cantidad, apruebas o excluyes en masa. Nada se mueve sin tu visto bueno."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M20 6L9 17l-5-5\"/></svg>",
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "En la venta real de los últimos 14, 30 o 60 días por sucursal (tú eliges el horizonte), cruzada contra el stock actual y los mínimos configurados. Es un motor de reglas claras — no una caja negra de ML por ahora."
      },
      {
        "question": "¿Puedo excluir productos que no quiero nivelar?",
        "answer": "Sí. Excluyes por SKU, familia, categoría o marca. Útil para joyería, exclusivos de una tienda o productos de temporada cerrada que no tiene sentido mover."
      },
      {
      ...
      },
      {
        ...
        "answer": "La diferencia se abre como \"faltante en tránsito\" y requiere investigación antes de ajustar. El stock de origen ya salió; el de destino solo se da de alta por lo efectivamente recibido."
      },
      {
        "question": "¿Se puede hacer nivelación entre regiones o solo dentro de la región?",
        "answer": "Ambas. Configuras el radio permitido: dentro de la región, entre regiones cercanas, o nacional. La aprobación inter-regional puede requerir un rol superior según cómo armes los permisos."
      },
      {
  ...
  "ordenes-de-compra": {
    ...
    "faqs": [
      {
        "question": "¿La sugerencia de compra considera el stock que viene en tránsito?",
        "answer": "Sí. La sugerencia mira stock disponible + stock en tránsito entrante (otras OC abiertas y traspasos). No te propone pedir de más si ya tienes mercancía en camino."
      },
      {
      ...
      },
      {
        ...
        "answer": "Hoy capturas la factura manualmente o subes el PDF/XML del proveedor. La integración directa con portales y sistemas de facturación del proveedor (para jalar el CFDI automáticamente) está en el roadmap para mercado mexicano primero."
      },
      {
        "question": "¿Puedo autorizar OC por monto o por proveedor?",
        "answer": "Sí. Configuras umbrales: OC hasta cierto monto las libera el gerente de compras; por arriba requiere dirección. También puedes exigir autorización especial para proveedores nuevos o fuera de lista."
      },
      {
        "question": "¿Cómo se actualiza el costo del inventario al recibir?",
        "answer": "El costo de las piezas recibidas se toma de la OC y alimenta el costo promedio de la sucursal o CEDIS donde entra. Si el precio en factura fue distinto al de la OC, puedes reajustar el costo antes de autorizar el pago."
      },
      {
        "question": "¿Puedo ver el desempeño histórico de cada proveedor?",
        "answer": "Sí. Por proveedor ves tiempo de entrega promedio real, % de pedido completo al primer envío, frecuencia de diferencias de precio, reclamos abiertos y cerrados. Te da argumentos para la siguiente negociación."
      },
      {
        "question": "¿Se generan las cuentas por pagar automáticamente?",
        "answer": "La OC con factura conciliada entra al calendario de cuentas por pagar con la fecha de vencimiento según los términos del proveedor. La integración completa con contabilidad y emisión de pagos está en el módulo de control financiero."
      }
    ]
  },
  "gastos": {
    ...
    "faqs": [
      {
        "question": "¿Los gerentes pueden capturar gastos sin tener acceso a ventas?",
        "answer": "Sí. El rol \"gerente de tienda\" puede capturar gastos de su sucursal sin ver reportes de otras tiendas ni información sensible de clientes o ventas. Tú configuras qué ve cada rol."
      },
      {
      ...
      },
      {
        ...
        "answer": "Hoy se registran con plantilla: guardas la renta como plantilla y el siguiente mes se captura con tres toques. La programación 100% automática (cargo mensual sin confirmar) está en el roadmap."
      },
      {
        "question": "¿Los gastos afectan la utilidad que se muestra en los reportes?",
        "answer": "Sí. Los gastos por sucursal se restan de las ventas de esa tienda para calcular utilidad bruta y neta. El reporte de margen real ya considera costos de venta, devoluciones y gastos operativos."
      },
      {
        "question": "¿Se puede separar caja chica de tarjeta corporativa?",
        "answer": "Sí. El método de pago es campo obligatorio al capturar. Tienes reportes separados por método — sabes cuánto sale de caja chica vs. tarjetas corporativas vs. transferencias."
      },
      {
        "question": "¿Qué pasa si un gerente captura mal un gasto?",
        "answer": "Los gastos abiertos se pueden editar. Una vez cerrado el periodo o autorizado, solo se corrige con un movimiento de ajuste que queda ligado al original. Nada se borra — todo queda en bitácora."
      },
      {
        "question": "¿Se integra con mi sistema contable?",
        "answer": "Hoy exportas a Excel y CSV con los campos que tu contable necesita. Las integraciones directas con Contpaqi, Aspel y Siigo están en roadmap. Para otros sistemas, el CSV funciona de inmediato."
      },
      {
        "question": "¿Puedo ver la utilidad de cada sucursal por separado?",
        "answer": "Sí. Cada sucursal tiene su propio estado de resultados: ventas, costo de mercancía, devoluciones, gastos operativos y utilidad. Ves qué tienda aporta y cuál está quemando efectivo."
      },
      {
        "question": "¿Cómo detecto desvíos o gastos sospechosos?",
        "answer": "El reporte comparativo entre sucursales y el histórico por categoría te muestran saltos inusuales. Si la luz de una tienda crece 40% en un mes sin razón, lo ves a la primera — sin auditoría externa."
      }
    ]
  },
  "cuentas-por-pagar": {
    ...
    "faqs": [
      {
        "question": "¿Puedo cargar facturas desde el XML del proveedor?",
        "answer": "Sí. Subes el XML CFDI y los datos entran llenos: RFC, folio, monto, impuestos, conceptos. Solo confirmas y el sistema crea la cuenta por pagar con el comprobante fiscal ligado."
      },
      {
      ...
      },
      {
        ...
        "answer": "Capturas la nota de crédito contra la factura original (o contra varias). El saldo del proveedor baja automáticamente. Si el neto queda a tu favor, se guarda como crédito disponible para compras futuras."
      },
      {
        "question": "¿Se pueden programar pagos futuros?",
        "answer": "Hoy tienes el calendario de vencimientos donde ves todo lo que viene y puedes marcar pagos como \"programados\". La emisión automática de pagos vía banco está en roadmap — mientras tanto, el recordatorio te deja pagar sin que se escape nada."
      },
      {
        "question": "¿Cómo se ven las cuentas por pagar por sucursal?",
        "answer": "Puedes ligar cada factura a la sucursal que recibió la mercancía o servicio. El reporte muestra cuentas por pagar por tienda — útil si cada sucursal maneja sus propios proveedores o si quieres estados de resultados separados."
      },
      {
        "question": "¿Puedo mandar un estado de cuenta al proveedor?",
        "answer": "Sí. Abres el proveedor y exportas su estado de cuenta en PDF: todas sus facturas, pagos aplicados y saldo. Se lo mandas por correo cuando pide confirmación — o cuando tú quieres verificar antes de pagar."
      },
      {
        "question": "¿Se integra con mi sistema contable?",
        "answer": "Exportas facturas, pagos y notas de crédito a Excel y CSV listos para contabilidad. Las integraciones directas con Contpaqi, Aspel y Siigo están en roadmap. El XML original se descarga para tu contador cuando lo pida."
      },
      {
        "question": "¿Quién puede autorizar pagos grandes?",
        "answer": "Configuras topes por usuario. Los pagos dentro del límite los ejecuta tu administrador sin aprobación; los que rebasan el tope piden PIN del dueño o director financiero. Todo queda en bitácora con usuario, hora y monto."
      }
    ]
  },
  "reportes-y-analitica": {
    ...
    "faqs": [
      {
        "question": "¿Qué tan actualizados están los números del dashboard?",
        "answer": "En tiempo real. Cada venta, devolución, ajuste de inventario o gasto se refleja en los KPIs al instante. No hay refresco nocturno ni corte de cierre — lo que pasó hace 30 segundos ya está en el dashboard."
      },
      {
        "question": "¿Puedo crear reportes personalizados?",
        "answer": "Los reportes base cubren la gran mayoría de preguntas con filtros cruzados (sucursal, vendedor, categoría, periodo, canal). Para consultas muy específicas, exportas la data a Excel y la trabajas ahí. El constructor de reportes personalizados está en roadmap."
      },
      {
        "question": "¿Los reportes están disponibles en móvil?",
        "answer": "Sí. El dashboard principal y los reportes clave se ven en celular y tablet — lectura optimizada para revisarlos en el camino. Los desgloses más densos se leen mejor en escritorio por el ancho de columnas."
      },
      {
        "question": "¿Cómo se calcula la utilidad bruta?",
        "answer": "Ventas netas (menos devoluciones) menos costo de mercancía vendida. El costo se toma del inventario al momento de la venta usando el método que configuraste (promedio o FIFO). Los gastos operativos se restan aparte para llegar a utilidad neta."
      },
      {
        "question": "¿Puedo comparar sucursales lado a lado?",
        "answer": "Sí. Seleccionas dos o más sucursales y las comparas en la misma vista: ventas, unidades, ticket promedio, margen, gastos. Útil para saber cuál tienda está liderando y por qué."
      },
      {
        "question": "¿Los reportes respetan los permisos por rol?",
        "answer": "Sí. Un gerente de tienda solo ve los reportes de su sucursal. Un administrador regional ve sus tiendas. El dueño ve todo. Los permisos se configuran por rol y por módulo."
      },
      {
        "question": "¿Se pueden programar reportes por correo?",
        "answer": "Los reportes se exportan a Excel y CSV bajo demanda. El envío automático por correo (reporte semanal que llega los lunes) está en roadmap. Mientras tanto, el enlace de descarga directo te deja armar tu rutina de revisión."
      },
      {
  ...
  "especialista-ia": {
    ...
    "features": [
      {
        ...
        "title": "Pregunta en español, sin reportes",
        "description": "Escribe \"¿cómo van mis ventas de hoy?\" o \"dame el top 10 de productos\" y el asistente consulta tu base de datos y te contesta al instante. No filtras tablas ni exportas Excel: hablas y te responde."
      },
      {
        ...
        "description": "La pantalla de inicio trae botones listos para lo que más se consulta: Ventas de Hoy, Ventas Semanales, Top 10 Productos, Top 10 Clientes, Mejor Vendedor y Ventas por Sucursal. Un clic y la respuesta llega."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"12\" cy=\"12\" r=\"10\"/><path d=\"M12 6v6l4 2\"/></svg>",
        "title": "Tus conversaciones, guardadas y buscables",
        "description": "Cada chat queda en la barra lateral con su título. Puedes buscar conversaciones anteriores por texto, retomarlas o borrarlas. El asistente recuerda el contexto de la charla."
      },
      {
        ...
        "title": "Elige el modelo de IA que necesitas",
        "description": "Selecciona entre varios modelos según la tarea, con etiquetas de velocidad (Muy Rápido / Rápido) y de razonamiento (Básico / Avanzado). Más razonamiento para análisis profundos, más velocidad para consultas simples."
      }
    ],
    ...
    "faqs": [
      {
        "question": "¿Esto ya está disponible para todos los clientes?",
        "answer": "No. Especialista IA está en programa piloto con Cohorte 1: diez retailers seleccionados durante seis meses. La versión pública sale después de incorporar el aprendizaje de ese ciclo. Si te interesa entrar a cohortes siguientes, lo hablamos en la llamada inicial."
      },
      {
        "question": "¿Quién es el especialista y rota?",
        "answer": "Conoces a tu especialista en la primera sesión y es el mismo durante todo el piloto. No hay cola de soporte ni turnos — el contexto de tu operación se acumula en una sola persona."
      },
      {
        "question": "¿Cuántas sesiones están incluidas?",
        "answer": "Durante el piloto de seis meses: una sesión de diagnóstico inicial (extendida), sesiones quincenales de una hora, y canal asincrónico entre sesiones para dudas puntuales. Queda documentado al firmar."
      },
      {
      ...
      },
      {
        ...
        "answer": "Cada flujo se prueba en sandbox con datos reales antes de producción. En las primeras horas de activación el especialista monitorea la ejecución. Si algo sale mal, hay un plan de rollback definido y el especialista lo aplica."
      },
      {
        "question": "¿Me entrenan para operar los flujos solo después?",
        "answer": "Sí. Uno de los objetivos del piloto es que tu equipo aprenda a ajustar los flujos existentes sin depender del especialista. Al final de los seis meses, tu gente edita triggers, pausa flujos y revisa métricas sin nuestra ayuda para tareas rutinarias."
      },
      {
        "question": "¿Cuánto cuesta?",
      ...
      {
        "question": "¿Qué obligaciones tengo como miembro de Cohorte 1?",
        "answer": "Asistir a las sesiones quincenales, compartir métricas de impacto honestas (funcione o no), y autorizar que usemos el aprendizaje anonimizado para mejorar la versión pública. No pedimos casos de estudio públicos ni testimonios pagados."
      }
    ]
  },
  "axo-copiloto-ia": {
    ...
    "features": [
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z\"/></svg>",
        "title": "Preguntas en español, sin SQL",
        "description": "Escribes como le hablarías a tu mano derecha. La IA entiende la intención y corre la consulta sobre tus datos reales de ventas, inventario y clientes. Tú solo preguntas; no hay reportes que armar."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"12\" cy=\"12\" r=\"10\"/><path d=\"M8 14s1.5 2 4 2 4-2 4-2M9 9h.01M15 9h.01\"/></svg>",
        "title": "Respuestas con tarjetas y gráficas",
        "description": "No es un texto suelto: la respuesta llega con tarjetas de KPI (ventas, ticket, clientes activos) y una gráfica cuando aplica. El número se ve, no se busca en seis pantallas."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M3 3v18h18\"/><path d=\"M7 14l4-4 4 4 5-5\"/></svg>",
        "title": "Dicta por voz o toma una foto",
        "description": "Desde el celular en piso: toca el micrófono y dicta la pregunta; la IA puede leerte la respuesta en voz alta. También tomas foto de un producto, un estante o un ticket de proveedor y la IA la interpreta para tu negocio."
      },
      {
        ...
        "title": "Acciones que tú confirmas",
        "description": "Cuando aplica, la IA propone un siguiente paso —por ejemplo, crear una promoción— y tú lo confirmas con un botón. La promo se crea en borrador pausado: nada afecta tus ventas hasta que tú la actives."
      }
    ],
    ...
    "faqs": [
      {
        "question": "¿AXO ya está disponible?",
        "answer": "Está en early access con retailers del programa piloto. Estamos abriendo cupos por cohortes pequeñas para asegurar calidad de respuestas. Si te interesa entrar, lo hablamos en la llamada de onboarding."
      },
      {
        "question": "¿Qué tipo de preguntas contesta bien hoy?",
        "answer": "Ventas por sucursal, por vendedor, por categoría; clientes VIP con baja recurrencia; inventario por producto y por talla; comparativas mes versus mes. Lo que no contesta todavía: pronósticos, recomendaciones de compra, análisis de margen complejos. El alcance se amplía cada cohorte."
      },
      {
      ...
      },
      {
        ...
        "answer": "No. Cada retailer opera en un silo. AXO usa los datos de tu cuenta para responder tus preguntas y nada más — no se cruzan aprendizajes con otras marcas."
      },
      {
        "question": "¿Cuánto cuesta?",
        "answer": "Durante early access, AXO está incluido sin costo adicional para clientes del piloto. Al salir la versión pública habrá un precio transparente — lo comunicaremos con al menos 60 días de aviso antes de cerrar el early access."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. En las sesiones con tu especialista o directo desde la app, marcas una respuesta como \"incompleta\" y explicas qué querías. Ese feedback entra al backlog de AXO y a veces se resuelve en la siguiente release."
      },
      {
        "question": "¿Cómo sé si la respuesta de AXO es correcta?",
        "answer": "Cada respuesta tiene cita de la fuente con link directo al reporte original. Un click te deja verificar el dato. Al principio recomendamos hacerlo con todas las respuestas hasta construir confianza — AXO no se ofende."
      }
    ]
  },
  "workflows": {
    ...
    "features": [
      {
        ...
        "title": "Tipos de proceso de servicio",
        "description": "Define distintos flujos según el tipo de trabajo del taller, como un proceso rápido y simplificado para servicios menores. Cada proceso muestra cuántos estados y servicios tiene."
      },
      {
        ...
        "title": "Pipeline de estados configurable",
        "description": "Arma la línea de tiempo por la que avanza cada orden: RECIBIDO, EN PROCESO y las etapas que tu taller necesite, cada una con su nombre y descripción."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z\"/></svg>",
        "title": "Estados con nombre, descripción y color",
        "description": "Desde el editor de proceso defines cada etapa con su nombre, su descripción y su color, para que el avance de la orden se lea de un vistazo."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M3 3v18h18\"/><path d=\"M7 14l4-4 4 4 5-5\"/></svg>",
        "title": "Integrado a Órdenes de Servicio",
        "description": "Los procesos que configuras aquí son los que siguen las reparaciones reales en el módulo de Órdenes de Servicio: la configuración y la operación viven en el mismo lugar."
      }
    ],
    ...
    "faqs": [
      {
        "question": "¿Los workflows ya están disponibles?",
        "answer": "Están en programa piloto con retailers seleccionados. El constructor visual y el catálogo de triggers/acciones se están estabilizando con feedback de Cohorte 1. La versión pública llega en 2026 con el aprendizaje incorporado."
      },
      {
        "question": "¿Necesito saber programar?",
        "answer": "No. El constructor es visual: arrastras triggers, condiciones y acciones, los conectas con líneas. Las condiciones se escriben en lenguaje de tienda (mayor que, pertenece a, en temporada alta). No hay que aprender sintaxis."
      },
      {
      ...
      },
      {
        ...
        "answer": "La bitácora registra el error y el paso donde ocurrió. Según el flujo, puedes configurar: reintentar X veces, escalar al dueño, o marcar como fallido y seguir. Nunca queda en limbo silencioso."
      },
      {
        "question": "¿Hay límite de workflows por cuenta?",
        "answer": "Durante el piloto recomendamos no pasar de 15-20 workflows activos, para evitar superposición de automatizaciones y mantener la legibilidad operativa. Al salir la versión pública el límite se revisará con base en los planes."
      },
      {
        "question": "¿Quién puede crear y modificar workflows?",
        "answer": "Se controla por permisos. Por default solo dueño y dirección pueden crear o editar. Gerentes pueden dispararlos manualmente (si el flujo lo permite) y ver ejecuciones en su sucursal. El cambio queda auditado."
      },
      {
        "question": "¿Cuánto tardan en disparar los triggers de tiempo real?",
        "answer": "Los triggers reactivos (venta cerrada, apartado creado) disparan en segundos. Los programados (diario, mensual) corren en la ventana configurada. No garantizamos milisegundos — si el caso de uso exige latencia baja, lo hablamos antes de construir."
      },
      {
        "question": "¿Puedo probar un flujo antes de activarlo?",
        "answer": "Sí. Cada workflow tiene modo \"prueba\": eliges un registro real (un apartado, un cliente, una venta) y simulas qué pasaría. Ves qué condiciones pasan, qué acciones se ejecutarían. No dispara efectos reales."
      },
      {
        "question": "¿Los workflows reemplazan al Especialista IA?",
        "answer": "No. Los workflows son la herramienta; el Especialista IA es quien te ayuda a decidir cuáles construir y cómo. Durante el piloto suelen ir juntos — puedes contratar workflows sin especialista cuando salgan al público, pero la curva de aprendizaje es más lenta."
      }
    ]
  },
  "alertas-inteligentes": {
    ...
    "features": [
      ...
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"4\" y=\"4\" width=\"16\" height=\"16\" rx=\"2\"/><path d=\"M9 9h6M9 13h6M9 17h3\"/></svg>",
        "title": "Aviso al instante donde estás trabajando",
        "description": "Las alertas llegan en tiempo real al panel: el sistema escucha tu cuenta y muestra el aviso en el momento, con título, mensaje y, cuando aplica, opción de confirmar o descartar. Nada se queda esperando a que entres a un reporte."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z\"/><circle cx=\"12\" cy=\"10\" r=\"3\"/></svg>",
        "title": "Cada alerta con su acción",
        "description": "Una alerta sin qué hacer es solo ruido. Las nuestras llegan con acción: abrir el registro relacionado, marcar como visto y descartado, o ejecutar el ajuste sugerido con un click."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M9 12l2 2 4-4\"/><circle cx=\"12\" cy=\"12\" r=\"10\"/></svg>",
        "title": "Por cuenta y por usuario",
        "description": "Las alertas se entregan por cuenta y por usuario: cada quien ve lo que le toca. El dueño recibe el panorama, sin saturar a todos con avisos ajenos."
      }
    ],
    ...
    "faqs": [
      {
        "question": "¿Las alertas inteligentes ya están disponibles?",
        "answer": "Están en desarrollo y en piloto con retailers seleccionados. Los módulos de ventas e inventario son los más maduros; los de clientes y proveedores están entrando a la cola del piloto en los próximos trimestres."
      },
      {
        "question": "¿Cómo aprende el sistema el patrón de mi negocio?",
        "answer": "Usa al menos 90 días de historia de tu operación para calibrar las bandas de normalidad por sucursal, producto y horario. Durante ese período las alertas son informativas; después pasan a ser accionables con el modelo afinado a tu negocio."
      },
      {
        "question": "¿Voy a recibir spam de alertas?",
        "answer": "Ese es justamente el problema que resolvemos. En piloto el objetivo es 3-5 alertas accionables por día por rol. Si pasa de ahí, el especialista afina los umbrales contigo. Preferimos quedarnos cortos y subir el volumen que abrumar."
      },
      {
        "question": "¿Puedo decirle al sistema que una alerta fue falsa?",
        "answer": "Sí. Cada alerta se cierra con \"acción tomada\", \"vista y descartada\" o \"falsa alarma\". Ese feedback afina el modelo para reducir falsos positivos en el futuro — no es un check cosmético."
      },
      {
        "question": "¿Quién recibe cada alerta?",
        "answer": "Configurable por rol y por sucursal. Por default: el dueño ve el panel consolidado de todas, el gerente de tienda solo las suyas, el responsable de compras las de inventario. Nadie se entera de lo que no le toca."
      },
      {
        "question": "¿Cómo se diferencia de un reporte de ventas tradicional?",
        "answer": "Un reporte te muestra todo; una alerta te muestra solo lo anómalo con acción sugerida. Son complementarios: el reporte sirve para ver tendencias en frío, la alerta para reaccionar en caliente."
      },
      {
      ...
      },
      {
        ...
        "answer": "Dependiendo del tipo, la alerta puede escalar: stock en riesgo pasa de amarilla a roja, VIP en silencio agrega nueva alerta a los 30 días sin acción. El dueño ve en su panel las alertas sin atender y puede configurar escalamiento automático al supervisor superior."
      },
      {
  ...
  "reportes-predictivos": {
    ...
    "features": [
      {
        ...
        "description": "Una IA entrenada con tu histórico de ventas proyecta cuánto vas a vender por SKU, sucursal y semana, para que reordenes con cabeza y no de memoria. Aspiracional: empieza a afinar a los 90 días de uso."
      },
      {
        ...
        "description": "Cada mañana, un resumen escrito en español claro: qué pasó ayer, qué hay que atender hoy y qué decisión te sugiere el sistema. En piloto con marcas beta, iterando la voz con feedback real."
      },
      {
        ...
        "title": "Rentabilidad real por SKU",
        "description": "Cruza costo, precio, promociones, devoluciones y merma para darte el margen real por producto, no el margen de catálogo. Early access, requiere tu histórico limpio para acertar."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"12\" cy=\"12\" r=\"10\"/><path d=\"M12 6v6l4 2\"/></svg>",
        "title": "Alertas anticipadas",
        "description": "El sistema te avisa antes de quedarte sin un best-seller o cuando una sucursal empieza a perder ritmo, para que actúes a tiempo. Piloto activo con la cohorte inicial."
      }
    ],
    ...
    "blocks": [
      ...
      },
      {
        ...
        "link": {
          "label": "Ver reportes contables",
          "href": "/producto/reportes-contables"
        },
        "featured": true,
    ...
    "faqs": [
      ...
      },
      {
        ...
        "answer": "Sí. Cada reporte — forecast, rentabilidad, resumen ejecutivo — se puede exportar a PDF o Excel. El resumen diario adjunta un PDF con el detalle numérico por si necesitas compartirlo con un socio o un banco."
      },
      {
        "question": "¿Los reportes reemplazan a mi contador?",
        "answer": "No. Los reportes son herramienta de gestión, no de cumplimiento fiscal. Tu contador sigue usando tus facturas y CFDI. Los reportes predictivos están diseñados para que tomes decisiones operativas más rápido."
      },
      {
        "question": "¿Qué pasa si el forecast se equivoca?",
  ...
  "orquestador-de-agentes": {
    ...
    "features": [
      {
        ...
        "title": "Asistente IA que lee tu base de datos (ya disponible)",
        "description": "Pregúntale en español: \"¿cuánto vendí esta semana?\", \"¿qué se está agotando?\", \"¿quién es mi mejor cliente?\". El asistente ejecuta consultas reales contra tus ventas, inventario y clientes, y te responde con el dato exacto."
      },
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M4 6h16M4 12h16M4 18h10\"/><path d=\"M18 15l3 3-3 3\"/></svg>",
      ...
      {
        "icon": "<svg width=\"32\" height=\"32\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2\"/><circle cx=\"9\" cy=\"7\" r=\"4\"/><path d=\"M19 8v6M22 11h-6\"/></svg>",
        "title": "Respuestas con respaldo, no inventadas",
        "description": "En lugar de adivinar, el asistente itera consultando tu información hasta tener el dato correcto, con tope de tiempo y de consultas para que sea rápido y acotado. Si el número está, lo saca de tu sistema."
      },
      {
        ...
        "title": "Orquestación multi-agente (en piloto cerrado)",
        "description": "El siguiente paso: varios modelos coordinados —uno redacta, otro revisa, otro consulta stock— con relevo limpio a una persona cuando hace falta. Está en early access con marcas selectas; te avisamos cuando abra."
      }
    ],
    ...
    "blocks": [
      ...
      },
      {
        ...
        "link": {
          "label": "Ver bandeja de atención",
          "href": "/producto/bandeja-unificada"
        },
        "featured": true,
    ...
    "faqs": [
      {
        "question": "¿Qué significa que el orquestador está en \"Early access\"?",
      ...
      {
        "question": "¿Puedo elegir qué modelo contesta?",
        "answer": "Puedes aceptar los defaults (recomendado) o configurar la tabla de modelos preferidos por tipo de tarea. Siempre hay fallback automático si el modelo primario no responde — la cadena no se rompe."
      },
      {
        "question": "¿Qué datos ven los modelos externos?",
        "answer": "Solo lo que tú permitas. Por defecto los modelos externos reciben lo necesario para contestar (pregunta, catálogo relevante, historial de la conversación). Datos sensibles como métodos de pago o documentos fiscales pueden quedar restringidos a modelos locales o con acuerdo explícito de no-entrenamiento."
      },
      {
        "question": "¿Cuánto cuesta operar múltiples modelos?",
        "answer": "Más que un solo modelo — pero el costo por conversación sigue siendo una fracción del costo de un agente humano. Cada pipeline tiene presupuesto estimado y tope configurable. Reportamos costo por conversación cada semana."
      },
      {
        "question": "¿Qué pasa si la IA contesta algo incorrecto?",
        "answer": "Primero, un modelo de revisión intercepta los casos más obvios. Segundo, debajo de cierta confianza el caso pasa a humano antes de enviarse. Tercero, cuando llega un error, se marca, se corrige, y la corrección se incorpora al pipeline — no vuelve a pasar lo mismo. Hay bitácora de todo."
      },
      {
      ...
      },
      {
        ...
        "answer": "Sí. Cualquier hilo se puede abrir en el panel de auditoría y ves: modelo por turno, confianza, fuentes consultadas, costo, tiempo de respuesta, quién revisó. Útil para reclamos de clientes o revisiones internas de calidad."
      },
      {
        "question": "¿Cómo entro al piloto?",
        "answer": "Pídelo en tu onboarding o a tu ejecutivo de cuenta. El acceso es selectivo porque queremos garantizar calidad y aprender de cada implementación. Si entras, recibes soporte directo del equipo y tu feedback influye en el producto final."
      }
    ]
  },
  "api-e-integraciones": {
    ...
    "features": [
      ...
      },
      {
        ...
        "title": "Cobra por donde quieras",
        "description": "Activa Stripe y Mercado Pago desde el panel de Integraciones para aceptar tarjeta, OXXO, transferencia y meses sin intereses. Conexión guiada, sin pelear con llaves técnicas."
      },
      {
        ...
        "title": "Envíos en automático",
        "description": "Conecta Skydropx y Envia.com para cotizar paqueterías (DHL, FedEx, Estafeta y más) y generar tus guías con tarifas prenegociadas, directo desde el flujo de tus pedidos."
      },
      {
        ...
        "title": "Tus credenciales, blindadas",
        "description": "Los tokens y llaves de cada conexión se cifran en el servidor y nunca viajan al navegador. Los webhooks de Shopify y WooCommerce se validan con firma HMAC para que solo entre lo legítimo."
      }
    ],
    ...
    "faqs": [
      {
        "question": "¿La API está disponible hoy o es roadmap?",
        "answer": "Está disponible hoy. Los endpoints core (productos, inventario, ventas, clientes, apartados, órdenes) son REST estándar, con documentación pública, sandbox de pruebas y tokens que puedes generar desde el panel de tu cuenta."
      },
      {
        "question": "¿Es cierto lo de \"+600 apps\"?",
        "answer": "Es honesto contigo: \"+600 apps\" es la meta del ecosistema a mediano plazo. Hoy tenemos integraciones oficiales en contabilidad, ecommerce, shipping y marketing con los partners más usados en LatAm, y sumamos nuevas cada mes. Si necesitas una que no está, con la API pública puedes armarla tú o pedirnos prioridad."
      },
      {
      ...
      },
      {
        ...
        "answer": "Hoy tenemos ejemplos en curl, Node y Python en la documentación. SDKs oficiales para Node y PHP están en roadmap de corto plazo. Mientras tanto, cualquier cliente HTTP funciona — la API es REST estándar."
      },
      {
        "question": "¿Hay ambiente de pruebas?",
        "answer": "Sí. Generas un token sandbox desde el panel y puedes probar contra datos ficticios sin afectar tu producción. Cuando tu integración esté lista, cambias el token al de producción y ya."
      },
      {
      ...
      {
        "question": "¿Puedo limitar qué puede hacer cada integración?",
        "answer": "Sí. Cada token se crea con scopes específicos (ej: inventory:read, sales:write, customers:read). Puedes restringir por IP, poner fecha de expiración, y revocar al instante desde el panel si algo se siente raro — sin afectar otros tokens activos."
      },
      {
        "question": "¿Puedo armar yo una integración desde cero?",
        "answer": "Sí, es el caso que mejor soportamos. Lees la documentación pública, generas un token sandbox, pruebas contra datos ficticios, y despliegas contra producción cuando estés listo. Si armas una integración útil y quieres publicarla en el catálogo, podemos evaluar listarla como community o partner."
      }
    ]
  }
};
