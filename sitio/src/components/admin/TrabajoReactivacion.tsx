  ...
  return (
    <div className="rx">
      ...
      <style>{`
        ...
        .rx-prog{flex:1;min-width:240px}.rx-prog-l{font-size:12.5px;color:#4a4658}.rx-prog-l b{font-size:15px;color:var(--tinta,#241d43)}.rx-red{color:#5B4BD6;font-weight:700}
        ...
        .rx-quien{background:var(--carta, #faf9fc);border:1px solid #ecebf2;border-radius:12px;padding:12px 14px;min-width:0}.rx-nombre{font-weight:800;font-size:16px}.rx-nombre span{font-weight:600;color:var(--suave,#6b6580)}.rx-p{margin-top:8px;font-size:13px;line-height:1.45}.rx-p span{color:#8e88a8}.rx-palanca{margin-top:8px;font-size:12px;color:#5B4BD6;font-weight:700}
        .rx-prev{background:var(--verde-a,#e7f7ee);border-radius:12px 12px 12px 4px;padding:10px 12px;font-size:14px;line-height:1.5;color:var(--tinta,#241d43);white-space:pre-wrap}.rx-fijo{color:var(--suave,#6b6580)}.rx-var{background:var(--neutro,#fff);border-radius:6px;padding:0 3px;box-shadow:inset 0 0 0 1px #c9ead6}
