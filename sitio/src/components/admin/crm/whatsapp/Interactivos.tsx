          ...
          <div className="wa-scroll" style={{ flex: 1, overflowY: 'auto', padding: '8px 20px 16px' }}>
            ...
            {tab === 'contacto' && (<>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                ...
                <div><label style={lab}>Teléfono (con lada)</label><input style={inp} value={vcard.telefono} onChange={e => setVcard({ ...vcard, telefono: e.target.value })} placeholder="+52 55 9302 7234" /></div>
