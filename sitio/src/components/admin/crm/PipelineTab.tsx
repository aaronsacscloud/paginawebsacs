...
function activityColor(tipo: string): string {
  const colors: Record<string, string> = {
    ...
    email_enviado: '#1565c0', email_recibido: '#1565c0', email_respuesta: '#1565c0', demo_agendada: '#E8A838', demo_realizada: '#F39C12',
...
function activityLabel(tipo: string): string {
  const labels: Record<string, string> = {
    ...
    email_enviado: 'Email enviado', email_recibido: 'Email recibido', email_respuesta: 'Te respondió por correo', demo_agendada: 'Demo agendada', demo_realizada: 'Demo realizada',
