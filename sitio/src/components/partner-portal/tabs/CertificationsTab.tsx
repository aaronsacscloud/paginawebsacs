...
const DEMO_CERTS: Cert[] = [
  {
    ...
    precio: 350000,
    precioMostrar: '$3,500',
    duracion: '4 horas en vivo + manual + 2 demos en role-play',
    nivel: 'Inicial · Obligatoria',
    cover: '/images/certificaciones/demos-consultoria-consciente.webp',
    descripcion: 'Aprende el método SACS de Consultoría Consciente para hacer demos del sistema en vivo — videollamada o presencial. Al certificarte desbloqueas la posibilidad de capturar leads directos en tu portal (clientes que tú mismo conociste, sin link).',
    paraQuien: 'Todo partner que quiera presentar SACS de manera profesional. Es la cert obligatoria para registrar leads directos en lugar de solo via link compartido.',
    temario: [
      ...
      'Cierre con propuesta: armar el paquete',
