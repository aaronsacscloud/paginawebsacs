...
export const Icon = {
  ...
  Quotes: (p: IconProps) => base({ ...p, children: <>
  ...
  Lock: (p: IconProps) => base({ ...p, children: <>
    <rect x="3" y="11" width="18" height="11" rx="2" />
    <path d="M7 11V7a5 5 0 0110 0v4" />
  </> }),
  Settings: (p: IconProps) => base({ ...p, children: <>
    <circle cx="12" cy="12" r="3" />
  ...
  Refresh: (p: IconProps) => base({ ...p, children: <>
    <polyline points="23 4 23 10 17 10" />
    <polyline points="1 20 1 14 7 14" />
    <path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15" />
  </> }),
  Zap: (p: IconProps) => base({ ...p, children: <>
  ...
  LogOut: (p: IconProps) => base({ ...p, children: <>
    <path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4" />
    <polyline points="16 17 21 12 16 7" />
    <line x1="21" y1="12" x2="9" y2="12" />
  </> }),
  AtSign: (p: IconProps) => base({ ...p, children: <>
