      ...
      {emailOpen && (
        <>
          ...
          <div style={SS.drawer}>
            ...
            <a href={`https://wa.me/524152838733?text=${encodeURIComponent(`Hola, soy ${user.nombre || 'partner'} (${user.email}). Quiero cambiar mi email principal a otro. Te confirmo los detalles aquí.`)}`}
