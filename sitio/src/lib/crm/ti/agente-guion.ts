...
Responde SOLO un JSON con esta forma:
{
 ...
 "datos": [{"campo":"nombre|apellido|email|empresa|modelo_negocio|giro|sucursales|ciudad|estado|sitio_web|instagram|puesto|plan_interes|sistema_actual|dolor|mejor_hora|canal_preferido|cuando_decide|tema_reunion|plan_elegido|periodo_pago|via_pago|otro","valor":"…","confianza":0.0-1.0,"evidencia":"cita textual corta","corrige":true|false}],
 ...
 "pide_info": true|false (true SOLO si en su último mensaje pide información general de Sacs —más información, conocer más, dónde ver el sistema, que le mandes algo para leer—; false si pregunta algo concreto o no pide nada),
