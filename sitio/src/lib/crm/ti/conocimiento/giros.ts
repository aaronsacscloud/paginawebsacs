...
export const GIROS: FichaGiro[] = [
  {
    ...
    // MAYOREO DE ROPA cae aquí pero habla distinto: su cliente es una tienda (no «cliente final»), vende por paquete/docena/surtido, lista de mayoreo y crédito, pedidos por WhatsApp o catálogo; una bodega puede ser cuenta grande. Tono neutro; módulos primero: cotización→pedido, listas mayoreo/menudeo, ventas a crédito y saldos, catálogo para que el cliente pida solo.
    ...
    dolores: [
      ...
      'Preguntan por WhatsApp y nadie sabe si eso sigue disponible.',
    ...
    tono: ['Con su vocabulario: talla, curva, colgada, temporada, percha.', 'Cercano, de tú («tu boutique»), cálido y profesional.'],
  ...
  },
  {
    ...
    queVenden: 'El clóset de sus consignantes: piezas únicas que no son suyas, a comisión pactada por contrato, con Lives y tienda en línea.',
    comoOperan: 'Reciben clósets (llega la consignante con dos maletas), valúan, firman contrato con comisión y vigencia, exhiben en piso y en Live, rinden cuenta a cada consignante, pagan o dejan saldo a favor, y regresan lo que no se vendió.',
    dolores: [
    ...
    argumento: 'Tu tienda no vende inventario: vende el clóset de tus consignantes. Cada pieza con su dueña, su comisión por contrato y su cuenta clara — y la liquidación sale sola.',
    ...
    tono: ['Con su vocabulario: consignante, comisión, pieza única, Live, saldo a favor, retiro.', 'Cercano, de tú; es una comunidad de consignantes.', 'Sencillo si apenas empieza.'],
  ...
  },
  {
    ...
    tono: ['Con su vocabulario: módulo, venue, encore, preventa, gira, fecha, staff.', 'Con el caso Liveshow y cifras: 100+ puntos de venta, 150,000 transacciones, sin internet.', 'Neutro, ejecutivo y de operación: menos «cliente», más «tu fecha».'],
  ...
  },
  {
    ...
    dolores: [
      ...
      'Piden cambio de talla y su talla ya voló.',
