...
export const PLANES: { id: PlanId; nombre: string; mensual: number; anualMes: number; anualTotal: number; paraQuien: string; agrega: string[]; servicios: string[] }[] = [
  ...
  },
  {
    ...
    servicios: ['Multi-sucursal', 'Reunión de introducción', 'Soporte 9 AM–5 PM', 'Tickets en 30–90 min', 'Migración gratis (3 días)'],
  },
  {
    ...
    servicios: ['Multi-sucursal', 'Reunión mensual', 'Soporte 9 AM–5 PM', 'Tickets en 15–30 min', 'Migración gratis (1 día)'],
  },
  {
    ...
    servicios: ['Multi-sucursal', 'Especialista IA dedicado', 'Onboarding de automatización', 'Soporte 24/7', 'Tickets en <2 min', 'Migración gratis'],
  },
];
...
- Cada plan incluye todo lo del anterior. Sin permanencia. La migración de tu sistema o Excel la hacemos nosotros.
...
- Descuentos, precios especiales, promociones, condiciones de contrato y facturación.
