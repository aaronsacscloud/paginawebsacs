...
export const crearClienteKapso = (nombre: string, externalId?: string) => req(PLATFORM, '/customers', { method: 'POST', body: JSON.stringify({ customer: { name: nombre, ...(externalId ? { external_id: externalId } : {}) } }) });
