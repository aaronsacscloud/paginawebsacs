...
export const META: Record<string, Def> = {
  ...
  '131049': D('Meta limitó el marketing a este número', 'Meta decidió no entregar más mensajes de marketing a este cliente por ahora (experimento de engagement).', 'Solo responde si él inicia, o usa una plantilla de utilidad.', 'limite'),
