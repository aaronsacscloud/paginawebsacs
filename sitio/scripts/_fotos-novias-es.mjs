...
const FOTOS = [
  ...
  ['es-9-reserva', `${COMUN} A bridal shop counter in Spain: the owner and a bride's mother finalising a booking; the owner points at a tablet on a stand showing an abstract blue record with a small calendar and payment rows, all unreadable. No money, no cards, no papers with text. Warm, trusting mood, dresses in garment bags behind.`],
  ['es-10-informe', `${COMUN} Early morning, shop still closed: the owner alone at a marble counter with a laptop showing an abstract blue dashboard — soft bar chart and a list of rows, unreadable — a cup of coffee beside it, wedding dresses in bags around her. Quiet, thoughtful, taking stock of the season.`],
  ['es-11-fiesta', `${COMUN} A shop assistant shows a mid-length party dress (not white — deep green or burgundy satin) to two women, mother and daughter, in the evening-wear corner of the bridal shop; a tablet rests on the counter with an abstract blue catalogue grid. Wedding dresses visible but out of focus behind. The mood is the bride's family coming back for another occasion.`],
  ['es-12-dos-tiendas', `${COMUN} Two women, one holding a tablet and one on the phone, standing between two rails of wedding dresses in a larger shop with an archway into a second room; a wall screen shows an abstract blue two-column list. The feeling is coordinating between two shops, calm, everything under control.`],
];
