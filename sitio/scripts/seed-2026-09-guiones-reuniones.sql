...
update espacio_canales set guion = '[
  {"bloque":"La semana que viene","quien":"Andrea","puntos":[
  ...
  {"bloque":"El dinero de la semana que viene","quien":"Andrea","puntos":[
  ...
  {"bloque":"La semana que viene","quien":"Aaron","puntos":[
  ...
  {"bloque":"Avisos","quien":"Aaron","puntos":[
  ...
  {"bloque":"El cierre","quien":"Los dos","puntos":[
...
update espacio_canales set guion = '[
  {"bloque":"Ideas","quien":"Andrea","puntos":[
    "Sus ideas locas, con ejemplos. Cualquier cosa entra."
  ]},
  {"bloque":"Ideas","quien":"Aaron","puntos":[
    "Lo mismo: lo que se le ocurra, con ejemplos."
  ]},
  {"bloque":"Qué se hace realidad","quien":"Los dos","puntos":[
...
update espacio_canales set guion = '[
  {"bloque":"Cuentas actuales","quien":"Andrea","puntos":[
    "Resultados de las cuentas que está atendiendo: expansión y mejora en el uso de SACS."
  ]},
  {"bloque":"Demos y cotizaciones","quien":"Andrea","puntos":[
  ...
  {"bloque":"Consultorías","quien":"Andrea","puntos":[
  ...
  {"bloque":"KPIs","quien":"Andrea","puntos":[
  ...
  {"bloque":"Campañas","quien":"Aaron","puntos":[
  ...
  {"bloque":"Marca y contenido","quien":"Aaron","puntos":[
    "Reuniones y leads que llegaron por marca personal y contenido, y cómo mejorarlo."
  ]},
  {"bloque":"Cómo conseguir más citas","quien":"Los dos","puntos":[
